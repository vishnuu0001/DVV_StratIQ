...
#Region " Return Dropdownlist values"
        Public Shared Sub SelectFeedbackTypeMasterList(ByRef ddlList As System.Web.UI.WebControls.DropDownList, Optional ByRef cnMasterConnection As SqlConnection = Nothing)
            Try
            ...
            Dim cmSelect As New SqlCommand("spSelFeedbackTypeMasterList", cnSubConnection.OpenConnection(cnMasterConnection))
