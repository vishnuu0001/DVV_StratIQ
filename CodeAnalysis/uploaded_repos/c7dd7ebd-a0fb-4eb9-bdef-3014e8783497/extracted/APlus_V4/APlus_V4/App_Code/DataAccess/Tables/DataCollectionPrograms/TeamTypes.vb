...
#Region " Select Team Types Master List"
        Public Shared Sub SelectTeamTypesMasterList(ByRef ddlList As System.Web.UI.WebControls.DropDownList, Optional ByRef cnMasterConnection As SqlConnection = Nothing)
            Try
            ...
            Dim cmSelect As New SqlCommand("spSelTeamTypesList", cnSubConnection.OpenConnection(cnMasterConnection))
