<%@ Page Language="VB" MasterPageFile="~/UI/Pages/MasterPages/ApplicationMaster.master"
    AutoEventWireup="false" CodeFile="KPIReport4.aspx.vb" Inherits="WebApp.APlus.UI.Pages.KPIReport4"
    Title="Key Asset BA Summary KPIs" %>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:Button ID="btnRunReport" runat="server" CssClass="Button_Default" Text="Run Report"
                                EnableViewState="False" Enabled="False" Visible="False"></asp:Button>
                        </td>
                        <td align="left">
