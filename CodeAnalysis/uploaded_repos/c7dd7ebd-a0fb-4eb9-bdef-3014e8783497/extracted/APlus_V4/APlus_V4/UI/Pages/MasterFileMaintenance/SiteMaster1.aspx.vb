...
Namespace WebApp.APlus.UI.Pages
    Partial Class SiteMaster1
        Inherits ApplicationBase

#Region " Constants"
        Private Shared ReadOnly FormName As String = "Site Master"
        Private Shared ReadOnly ProgramName As String = "SiteMaster1"
#End Region
        ...
        Protected Sub MasterControl1_onRowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles MasterControl1.onRowCommand
            ...
            Select Case e.CommandName
                Case "ViewRow", "EditRow", "DeleteRow"
                    SessionManager.SelectedValueSiteID = MasterControl1.MasterControlGrid.DataKeys(e.CommandArgument)("SiteID").ToString
                    SessionManager.SelectedValueSite = MasterControl1.Rows(CInt(e.CommandArgument)).Cells(1).Text
                    SessionManager.SiteMasterMode = e.CommandName
                    LastPixelPositionUpdate(ProgramName, Master.CurrentPixelPosition)

                    Response.Redirect(Context.Request.ApplicationPath & Path.AltDirectorySeparatorChar & ProgramSecurity.GetProgramURL("SiteMaster2"), False)
            End Select
        End Sub
#End Region
