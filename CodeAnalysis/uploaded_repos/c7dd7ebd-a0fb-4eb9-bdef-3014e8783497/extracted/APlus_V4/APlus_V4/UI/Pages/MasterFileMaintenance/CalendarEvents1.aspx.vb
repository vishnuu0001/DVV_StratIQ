...
#Region " Constants"
        ...
        Private Shared ReadOnly ProgramName As String = "CalendarEvents1"
#End Region
...
#Region " Event Handlers"
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            MasterControl1.GridColumns(4).DataFormatString = "{0:" + SessionManager.DateFormat + "}"
        End Sub
        ...
        Protected Sub MasterControl1_onRowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles MasterControl1.onRowCommand
            ...
            Select Case e.CommandName
                Case "ViewRow", "EditRow", "DeleteRow"
                    SessionManager.CalendarEventsSelectedID = MasterControl1.MasterControlGrid.DataKeys(e.CommandArgument)("CalendarEventID").ToString
                    SessionManager.CalendarEventsMode = e.CommandName
                    Response.Redirect(Context.Request.ApplicationPath & Path.AltDirectorySeparatorChar & ProgramSecurity.GetProgramURL("CalendarEvents2"), False)
            End Select
        End Sub
#End Region
