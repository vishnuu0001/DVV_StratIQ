...
Namespace WebApp.APlus.UI.Pages
    Partial Class JobSkillAttachments1
        Inherits ApplicationBase

#Region " Constants"
        Private Shared ReadOnly FormName As String = "Job Skill Documents"
        Private Shared ReadOnly ProgramName As String = "JobSkillAttachments1"
#End Region
...
#Region " Event Handlers"
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            MasterControl1.StoredProcedureParams.Add("@JobSkillID", SessionManager.AttachmentJobSkillID)
        End Sub
        ...
        Protected Sub MasterControl1_onRowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles MasterControl1.onRowCommand
            ...
            If e.CommandName = "ViewRow" Or e.CommandName = "DeleteRow" Or e.CommandName = "EditRow" Then
                SessionManager.SelectedValue1 = MasterControl1.Rows(CInt(e.CommandArgument)).Cells(0).Text
                SessionManager.SelectedValue2 = MasterControl1.Rows(CInt(e.CommandArgument)).Cells(3).Text
                SessionManager.SelectedValue3 = MasterControl1.Rows(CInt(e.CommandArgument)).Cells(2).Text
                SessionManager.JobSkillAttachmentsMode = e.CommandName
                Response.Redirect(Context.Request.ApplicationPath & Path.AltDirectorySeparatorChar & ProgramSecurity.GetProgramURL("JobSkillAttachments2"), False)
            End If
        End Sub
#End Region
