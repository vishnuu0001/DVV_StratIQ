...
Namespace WebApp.APlus.UI.Pages
    Partial Class TrainingDocumentAttachments1
        Inherits ApplicationBase

#Region " Constants"
        Private Shared ReadOnly FormName As String = "Training Document Attachments"
        Private Shared ReadOnly ProgramName As String = "TrainingDocumentAttachments1"
#End Region
...
#Region " Event Handlers"
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            MasterControl1.StoredProcedureParams.Add("@AttachmentTypeID", AttachmentTypes.SelectAttachmentTypeIDByType("Training"))
        ...
        Protected Sub MasterControl1_onRowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles MasterControl1.onRowCommand
            ...
            Select Case e.CommandName
                Case "ViewFile"
                    Dim strDir As String = ConfigurationManager.AppSettings("TrainingAttachmentsVirtualRootDirectory")
                ...
                Case "DeleteRow", "ViewRow"
                    ...
                    SessionManager.TrainingAttachmentMode = e.CommandName

                    Response.Redirect(Context.Request.ApplicationPath & Path.AltDirectorySeparatorChar & ProgramSecurity.GetProgramURL("TrainingDocumentAttachments2"), False)
            End Select
        End Sub
#End Region
