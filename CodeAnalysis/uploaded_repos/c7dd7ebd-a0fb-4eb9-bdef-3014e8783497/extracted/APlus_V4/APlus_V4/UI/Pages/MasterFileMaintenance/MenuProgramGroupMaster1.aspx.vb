...
Namespace WebApp.APlus.UI.Pages
    Partial Class MenuProgramGroupMaster1
        Inherits ApplicationBase

#Region " Private Constants"
        Private Shared ReadOnly FormName As String = "Menu Program Group Master"
        Private Shared ReadOnly ProgramName As String = "MenuProgramGroupMaster1"
#End Region
...
#Region " Event Handlers"
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If SessionManager.SelectedValueMenu = String.Empty Then
                MasterControl1.StoredProcedureParams.Add("@Menu", "")
            Else
                MasterControl1.StoredProcedureParams.Add("@Menu", SessionManager.SelectedValueMenu)
            End If

            If SessionManager.MenuMode = "ViewRow" Then
        ...
        Protected Sub MasterControl1_onRowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles MasterControl1.onRowCommand
            ...
            Select Case e.CommandName
                Case "ViewRow", "EditRow", "DeleteRow"
                    SessionManager.SelectedValueProgramGroup = MasterControl1.MasterControlGrid.DataKeys(e.CommandArgument)("ProgramGroup").ToString
                    SessionManager.MenuProgramGroupMode = e.CommandName
                    Response.Redirect(Context.Request.ApplicationPath & Path.AltDirectorySeparatorChar & ProgramSecurity.GetProgramURL("MenuProgramGroupMaster2"), False)
            End Select
        End Sub
#End Region
