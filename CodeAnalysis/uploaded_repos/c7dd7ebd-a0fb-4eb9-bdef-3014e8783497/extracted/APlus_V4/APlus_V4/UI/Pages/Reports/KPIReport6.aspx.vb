...
Namespace WebApp.APlus.UI.Pages
    Partial Class KPIReport6
        Inherits ApplicationBase

#Region " Private Variables"
        Private Shared ReadOnly FormName As String = "Key Asset KPIs"
        Private Shared ReadOnly ProgramName As String = "KPIReport6"
#End Region
...
#Region " Event Handlers"
        ...
        Private Sub ButtonClick(ByVal passArgs As String)
            ...
            ElseIf strTarget.Length = 3 AndAlso IsNumeric(strTarget(2)) Then
                ...
                SessionManager.CallingProgram = "KPIReport6"
        ...
        Protected Sub btnShowTargets_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnShowTargets.Click
            Dim cookie As New HttpCookie("KPIReport5Program", "KPIReport5")
            ...
            Response.Redirect(Context.Request.ApplicationPath & Path.AltDirectorySeparatorChar & ProgramSecurity.GetProgramURL("KPIReport5"), False)
        End Sub
        Protected Sub btnEditKPIReport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnEditKPIReport.Click
            SessionManager.MasterControlExitProgram = "KPIReport6"
            If ddlBusinessArea.SelectedItem IsNot Nothing AndAlso IsNumeric(ddlBusinessArea.SelectedItem.Value) Then
...
#Region " Custom Methods"
        ...
        Private Sub BindGrid()
            ...
            Dim objDT As DataTable = KPIValues.SelectKPIReport5CollectionNoTargets(iYear, SessionManager.SelectedKPIReportGroupID, iBusinessAreaID, iSiteID)
