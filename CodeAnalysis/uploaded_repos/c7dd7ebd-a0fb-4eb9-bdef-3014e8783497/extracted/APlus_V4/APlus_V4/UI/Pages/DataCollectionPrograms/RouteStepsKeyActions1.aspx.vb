...
Namespace WebApp.APlus.UI.Pages
    Partial Class RouteStepsKeyActions1
        Inherits ApplicationBase

#Region " Private Constants"
        Private Shared ReadOnly FormName As String = "Route Steps Key Actions"
        Private Shared ReadOnly ProgramName As String = "RouteStepsKeyActions1"
#End Region
...
#Region " Event Handlers"
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If SessionManager.SelectedRoute <> String.Empty Then
                ...
                SessionManager.MasterControlExitProgram = "RouteStepsMasterMaintenance2"
            End If
        ...
        Protected Sub MasterControl1_onRowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles MasterControl1.onRowCommand
            ...
            If e.CommandName = "ViewRow" Or e.CommandName = "DeleteRow" Or e.CommandName = "EditRow" Then
                SessionManager.SelectedKeyActionNo = MasterControl1.Rows(CInt(e.CommandArgument)).Cells(2).Text
                SessionManager.RouteStepsKeyActionsMode = e.CommandName
