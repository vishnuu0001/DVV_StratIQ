...
Namespace WebApp.APlus.UI.Pages
    Partial Class AreaGroupMaster1
        Inherits ApplicationBase

#Region " Private Constants"
        Private Shared ReadOnly FormName As String = "Area Group Maintenance"
        Private Shared ReadOnly ProgramName As String = "AreaGroupMaster1"
#End Region
        ...
        Protected Sub MasterControl1_onRowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles MasterControl1.onRowCommand
            ...
            Select Case e.CommandName
                Case "ViewRow", "EditRow", "DeleteRow"
                    SessionManager.SelectedValueAreaGroupID = MasterControl1.MasterControlGrid.DataKeys(e.CommandArgument)("AreaGroupID").ToString
                    SessionManager.AreaGroupMasterMode = e.CommandName

                    Response.Redirect(Context.Request.ApplicationPath & Path.AltDirectorySeparatorChar & ProgramSecurity.GetProgramURL("AreaGroupMaster2"), False)
            End Select
        End Sub
#End Region
