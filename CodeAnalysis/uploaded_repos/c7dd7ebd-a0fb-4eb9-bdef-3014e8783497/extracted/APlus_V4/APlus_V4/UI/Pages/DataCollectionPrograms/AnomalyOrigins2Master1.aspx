<%@ Page Language="VB" MasterPageFile="~/UI/Pages/MasterPages/ApplicationMaster.master"
    AutoEventWireup="false" CodeFile="AnomalyOrigins2Master1.aspx.vb" Inherits="WebApp.APlus.UI.Pages.AnomalyOrigins2Master1"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <CC1:MasterControl ID="MasterControl1" runat="server" CommandText="spSelAnomalyOrigins2"
                FormName="Anomaly Origin 2 Maintenance" NewLinkCaption="Anomaly Origin 2" ProgramMode="Origin2Mode"
                ProgramName="AnomalyOrigins2Master1" RedirectProgramName="AnomalyOrigins2Master2"
                ...
                <GridColumns>
                    ...
                    <CC1:MasterControlField DataField="AnomalyOrigin3" SortExpression="AnomalyOrigin3"
                        HeaderText="Origin 3 Count">
                    </CC1:MasterControlField>
                </GridColumns>
            </CC1:MasterControl>
