...
Namespace WebApp.APlus.UI.Pages
    Partial Class TeamOPIEvents1
        Inherits ApplicationBase

#Region " Constants"
        Private Shared ReadOnly FormName As String = "Team OPI Events"
        Private Shared ReadOnly ProgramName As String = "TeamOPIEvents1"
#End Region
...
#Region " Event Handlers"
        ...
        Protected Sub MasterControl1_onRowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles MasterControl1.onRowCommand
            ...
            If e.CommandName = "ViewRow" Or e.CommandName = "DeleteRow" Or e.CommandName = "EditRow" Then
                SessionManager.SelectedValueEventDate = MasterControl1.MasterControlGrid.DataKeys(e.CommandArgument)("EventDate").ToString 'MasterControl1.Rows(CInt(e.CommandArgument)).Cells(2).Text
                SessionManager.TeamOPIEventMode = e.CommandName
                Response.Redirect(Context.Request.ApplicationPath & Path.AltDirectorySeparatorChar & ProgramSecurity.GetProgramURL("TeamOPIEvents2"), False)
            End If
        End Sub
#End Region
