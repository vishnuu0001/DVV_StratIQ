...
Namespace WebApp.APlus.UI.Pages
    Partial Class TeamBusinessAreaChange2
        Inherits ApplicationBase

#Region " Private Variables"
        Private Shared ReadOnly FormName As String = "Team Business Area Maintenance"
        Private Shared ReadOnly ProgramName As String = "TeamBusinessAreaChange2"
        ...
        Private Sub btnOK_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnOK.Click
            ...
            For iRow As Integer = 0 To mcTeam.Rows.Count - 1
                Try
                    ...
                    Teams.UpdateTeamBusinessArea(iTeamID, iBusinessAreaID)

                    RecordTransactionHistory.InsertRecordTransactionHistory("Teams", iTeamID.ToString, "Business Area Changed: " & strBusinessArea, SessionManager.UserID)
            ...
            Response.Redirect(Context.Request.ApplicationPath & Path.AltDirectorySeparatorChar & ProgramSecurity.GetProgramURL("TeamBusinessAreaChange1"), False)
        End Sub
