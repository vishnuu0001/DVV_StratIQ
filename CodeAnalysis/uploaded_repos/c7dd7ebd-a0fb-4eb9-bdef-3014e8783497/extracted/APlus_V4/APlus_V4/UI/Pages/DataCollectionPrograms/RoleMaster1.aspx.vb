...
#Region " Constants"
        ...
        Private Shared ReadOnly ProgramName As String = "RoleMaster1"
#End Region
...
#Region " Event Handlers"
        ...
        Protected Sub MasterControl1_onRowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles MasterControl1.onRowCommand
            ...
            If e.CommandName = "ViewRow" OrElse e.CommandName = "DeleteRow" Then
                SessionManager.SelectedValue = MasterControl1.MasterControlGrid.DataKeys(e.CommandArgument)("Role").ToString
                SessionManager.SelectedValue1 = MasterControl1.MasterControlGrid.DataKeys(e.CommandArgument)("RoleType").ToString
                SessionManager.RoleMasterMode = e.CommandName
                LastPixelPositionUpdate(ProgramName, Master.CurrentPixelPosition)

                Response.Redirect(Context.Request.ApplicationPath & Path.AltDirectorySeparatorChar & ProgramSecurity.GetProgramURL("RoleMasterMaintenance2"), False)
            End If
        End Sub
#End Region
