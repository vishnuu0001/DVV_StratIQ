...
Namespace WebApp.APlus.UI.Pages
    Partial Class KPIReport3
        Inherits ApplicationBase

#Region " Private Variables"
        Private Shared ReadOnly FormName As String = "WRP KPIs"
        Private Shared ReadOnly ProgramName As String = "KPIReport3"
#End Region
...
#Region " Event Handlers"
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If Not Page.IsPostBack Then
                SessionManager.SelectedKPIReportGroupID = 3
                LoadDropDownLists()
        ...
        Protected Sub btnApplyFilter_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnApplyFilter.Click
            Dim cookie As New HttpCookie("KPIReport3Filter")
        ...
        Private Sub Button_Click(ByVal sender As System.Object, ByVal e As WebControls.CommandEventArgs)
            ...
            If strTarget.Length = 2 AndAlso IsNumeric(strTarget(1)) Then
                ...
                SessionManager.CallingProgram = "KPIReport3"
        ...
        Protected Sub btnRunReport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRunReport.Click
            Try
                ...
                strURL += "?ReportKey=KPIReport6"
                strURL += "&ReportParams="
                If Not String.IsNullOrEmpty(strKPIReportCategory) Then
                    strURL += "KPIReportCategoryID=" & strKPIReportCategory & "|"
                End If
                strURL += "KPIPeriod=" & dtPeriod.Year.ToString & "/" & dtPeriod.Month.ToString & "/01"
        ...
        Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
            ...
            Try
                ...
                Dim objDT As DataTable = KPIValues.SelectKPIReport3Collection(iYear, strKPIReportCategory, SessionManager.SelectedKPIReportGroupID, iBusinessAreaID, iSiteID)
                ...
                strHolder += "<td>YTD</td><td>Target</td></tr>"
                For Each dtRow As DataRow In objDT.Rows
                    strHolder += "<tr>"
                    strHolder += "<td>" + dtRow("BusinessArea").ToString.Trim + " : " + dtRow("KPIReportName").ToString.Trim + "</td>"
        ...
        Protected Sub btnEditKPIReport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnEditKPIReport.Click
            SessionManager.MasterControlExitProgram = "KPIReport3"
            If ddlBusinessArea.SelectedItem IsNot Nothing AndAlso IsNumeric(ddlBusinessArea.SelectedItem.Value) Then
...
#Region " Custom Methods"
        ...
        Private Sub ApplyFiltersFromCookie()
            ...
            If Request.Cookies("KPIReport3Filter") IsNot Nothing Then
                Dim cookie As HttpCookie = Request.Cookies("KPIReport3Filter")
                ...
                For i As Integer = 13 To 26
                    ...
                    If i < 25 Then
                        If IsNumeric(dtRow(i).ToString) Then
                            If IsNumeric(dtRow(i).ToString) AndAlso IsNumeric(dtRow(i + 14).ToString) AndAlso IsNumeric(dtRow("Prev").ToString) Then
                                If bTargetUp Then
                                    If CDbl(dtRow(i).ToString) >= CDbl(dtRow(i + 14).ToString) Then
                                ...
                                Else
                                    ...
                                    End If
                                End If
                            ElseIf IsNumeric(dtRow(i).ToString) AndAlso IsNumeric(dtRow(i + 14).ToString) Then
                                If bTargetUp Then
                                    If CDbl(dtRow(i).ToString) >= CDbl(dtRow(i + 14).ToString) Then
                                        objCell.BackColor = Drawing.Color.LightGreen
                                    Else
