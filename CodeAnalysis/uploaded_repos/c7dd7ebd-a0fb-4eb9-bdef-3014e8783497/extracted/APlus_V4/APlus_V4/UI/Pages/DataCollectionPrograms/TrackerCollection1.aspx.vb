...
Namespace WebApp.APlus.UI.Pages
    Partial Class TrackerCollection1
        Inherits ApplicationBase

#Region " Private Constants"
        Private Shared ReadOnly FormName As String = "Savings Types"
        Private Shared ReadOnly ProgramName As String = "TrackerCollection1"
#End Region
...
#Region " Event Handlers"
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If SessionManager.SelectedValueTrackerID > 0 Then
        ...
        Protected Sub MasterControl1_onRowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles MasterControl1.onRowCommand
            ...
            Select Case e.CommandName
                Case "ViewRow", "EditRow", "DeleteRow"
                    SessionManager.SelectedValueTrackerCollectionID = MasterControl1.MasterControlGrid.DataKeys(e.CommandArgument)("TrackerCollectionID").ToString
                    SessionManager.TrackerCollectionMode = e.CommandName

                    Response.Redirect(Context.Request.ApplicationPath & Path.AltDirectorySeparatorChar & ProgramSecurity.GetProgramURL("TrackerCollection2"), False)
            End Select
        End Sub
#End Region
