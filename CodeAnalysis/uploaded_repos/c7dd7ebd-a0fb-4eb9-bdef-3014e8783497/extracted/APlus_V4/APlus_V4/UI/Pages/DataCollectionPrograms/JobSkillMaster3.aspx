<%@ Page Language="VB" ValidateRequest="false" MasterPageFile="~/UI/Pages/MasterPages/ApplicationMaster.master"
    AutoEventWireup="false" CodeFile="JobSkillMaster3.aspx.vb" Inherits="WebApp.APlus.UI.Pages.JobSkillMaster3"
    ...
    <asp:Panel ID="pnlSpreadsheet" runat="server">
        ...
        <table id="tbButtons2" class="Table_Default">
            <tr>
                ...
                <td>
                    <asp:Button ID="btnCancel" runat="server" Text="Exit" CssClass="Button_Default" CausesValidation="False">
                    </asp:Button>
                </td>
            </tr>
        </table>
    </asp:Panel>
    <asp:Panel ID="pnlImport" runat="server" Visible="False" SkinID="GridView">
        <asp:GridView ID="grdImport" runat="server" Width="100%" 
