...
Namespace WebApp.APlus.UI.Pages
    Partial Class FXRates1
        Inherits ApplicationBase

#Region " Private Constants"
        Private Shared ReadOnly FormName As String = "FX Rates Maintenance"
        Private Shared ReadOnly ProgramName As String = "FXRates1"
#End Region
        ...
        Protected Sub MasterControl1_onRowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles MasterControl1.onRowCommand
            ...
            Select Case e.CommandName
                Case "ViewRow", "EditRow", "DeleteRow"
                    SessionManager.SelectedValueFXRateID = MasterControl1.MasterControlGrid.DataKeys(e.CommandArgument)("FXRateID").ToString
                    SessionManager.FXRateElementMode = e.CommandName
