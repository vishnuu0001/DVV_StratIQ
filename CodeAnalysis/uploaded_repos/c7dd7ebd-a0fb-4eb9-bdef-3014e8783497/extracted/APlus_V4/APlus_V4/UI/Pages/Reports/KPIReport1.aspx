<%@ Page Language="VB" MasterPageFile="~/UI/Pages/MasterPages/ApplicationMaster.master"
    AutoEventWireup="false" CodeFile="KPIReport1.aspx.vb" Inherits="WebApp.APlus.UI.Pages.KPIReport1"
    Title="Group KPIs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <tr>
                    <td>
                        <table>
                            <tr>
                                <td valign="top">
                                    <asp:Label ID="lblReport" runat="server" Text="KPI:" CssClass="Label_Left_8PT"></asp:Label>
                                </td>
                                <td>
                                    <asp:ListBox ID="lbReport" runat="server" CssClass="Textbox_Entry" Height="145px"
                                        Rows="12" SelectionMode="Multiple" Width="219px"></asp:ListBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <asp:CheckBox ID="ckAllReports" runat="server" Text="Show All KPIs For Selected Business Area" />
                                </td>
                            </tr>
                        </table>
                    </td>
                    <td valign="top">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:CheckBox ID="ckAllBusinessAreas" runat="server" Text="Show Selected KPI(s) For All Business Areas" />
                                </td>
                            </tr>
                            <tr>
                                <td class="style5">
                            ...
                            <tr>
                                <td align="right" class="style5">
                                    <asp:Label ID="lblYear" runat="server" Text="Year:" CssClass="Label_Left_8PT"></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtYear" runat="server" CssClass="Textbox_Entry" MaxLength="4" Width="51px"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                    </td>
            ...
            <asp:RequiredFieldValidator ID="reqYear" runat="server" ErrorMessage="Enter Year"
                ControlToValidate="txtYear" Display="None" CssClass="Label_Left_8PT"></asp:RequiredFieldValidator>
