...
Namespace WebApp.APlus.UI.Pages
    Partial Class RouteSteps1
        Inherits ApplicationBase

#Region " Constants"
        Private Shared ReadOnly FormName As String = "Route Steps Master"
        Protected WithEvents lnkPrintPage As System.Web.UI.WebControls.HyperLink
        Private Shared ReadOnly ProgramName As String = "RouteStepsMasterMaintenance"
#End Region
...
#Region " Event Handlers"
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If SessionManager.SelectedRoute <> String.Empty Then
                ...
                SessionManager.MasterControlExitProgram = "RoutesMasterMaintenance2"
            ElseIf SessionManager.SelectedTeamID > 0 Then
                strRouteHolder = Teams.GetTeamRoute(SessionManager.SelectedTeamID)
                SessionManager.SelectedRoute = strRouteHolder
            End If

            If strRouteHolder.Trim.Length > 0 Then
                'filter the grid by the selected team
        ...
        Protected Sub MasterControl1_onRowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles MasterControl1.onRowCommand
            ...
            If e.CommandName = "ViewRow" Or e.CommandName = "DeleteRow" Or e.CommandName = "EditRow" Then
                SessionManager.SelectedRouteStepNo = MasterControl1.Rows(CInt(e.CommandArgument)).Cells(1).Text
                SessionManager.RoutesStepsMode = e.CommandName
