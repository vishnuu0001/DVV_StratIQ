...
Namespace WebApp.APlus.UI.Pages
    Partial Class FeedbackMaster1
        Inherits ApplicationBase

#Region " Constants"
        Private Shared ReadOnly FormName As String = "Feedback Master"
        Private Shared ReadOnly ProgramName As String = "FeedbackMaster"
#End Region
...
#Region " Event Handlers"
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If Not Page.IsPostBack Then
                If Not IsNothing(Request.Cookies("FeedbackMaster")) Then
                    chkDisplayProcessed.Checked = Request.Cookies("FeedbackMaster").Value
                End If
            End If

            MasterControl1.StoredProcedureParams.Add("@ShowProcessed", chkDisplayProcessed.Checked)

            Dim cookie As HttpCookie
            cookie = New HttpCookie("FeedbackMaster", chkDisplayProcessed.Checked)
        ...
        End Sub
        Protected Sub chkDisplayProcessed_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles chkDisplayProcessed.CheckedChanged
            Try
                If SessionManager.CheckEventTrackerLevel(SessionManager.EventTrackerLevels.UIMasterFile) Then
                    Dim functionInfo As System.Reflection.MethodBase = System.Reflection.MethodBase.GetCurrentMethod()
        ...
        Protected Sub MasterControl1_onRowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles MasterControl1.onRowCommand
            ...
            Select Case e.CommandName
                Case "EditRow"
                    SessionManager.SelectedValue = MasterControl1.MasterControlGrid.DataKeys(e.CommandArgument)("ID").ToString
                    SessionManager.FeedbackMode = e.CommandName
                    Response.Redirect(Context.Request.ApplicationPath & Path.AltDirectorySeparatorChar & ProgramSecurity.GetProgramURL("FeedbackMaster2"), False)
            End Select
        End Sub
#End Region
