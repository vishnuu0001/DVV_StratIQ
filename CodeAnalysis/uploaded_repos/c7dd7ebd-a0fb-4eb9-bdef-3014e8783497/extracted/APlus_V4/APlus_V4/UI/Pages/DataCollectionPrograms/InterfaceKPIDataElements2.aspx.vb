...
Namespace WebApp.APlus.UI.Pages
    Partial Class InterfaceKPIDataElements2
        Inherits ApplicationBase

#Region " Private Constants"
        Private Shared ReadOnly FormName As String = "KPIDataElements not in InterfaceDataElementsMaster"
        Private Shared ReadOnly ProgramName As String = "InterfaceKPIDataElements2"
#End Region
        ...
        Protected Sub MasterControl1_onRowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles MasterControl1.onRowCommand
            ...
            Select Case e.CommandName
                Case "EditRow"
                    ...
                    SessionManager.CallingProgram = "InterfaceKPIDataElements2"
