...
Namespace WebApp.APlus.UI.Pages
    Partial Class TeamBusinessAreaChange1
        Inherits ApplicationBase

#Region " Members"
        Private Shared ReadOnly FormName As String = "Team Business Area Change"
        Private Shared ReadOnly ProgramName As String = "TeamBusinessAreaChange1"
...
#Region " Event Handlers"
        ...
        Protected Sub btnProcess_Click(sender As Object, e As System.EventArgs) Handles btnProcess.Click
            ...
            For iRow As Integer = 0 To grdTeam.Rows.Count - 1
                If TypeOf grdTeam.Rows(iRow).Cells(GridColumns.ChangeTeam).Controls(1) Is CheckBox Then
                    If DirectCast(grdTeam.Rows(iRow).Cells(GridColumns.ChangeTeam).Controls(1), CheckBox).Checked Then
                        ...
                        strKPI += grdTeam.DataKeys(iRow)("TeamID").ToString
                    End If
                End If
            Next
            ...
            If strKPI.Trim.Length > 0 Then
                ...
                Response.Redirect(Context.Request.ApplicationPath & Path.AltDirectorySeparatorChar & ProgramSecurity.GetProgramURL("TeamBusinessAreaChange2"), False)
            End If
        End Sub
#End Region
...
#Region " Methods"
        ...
        Private Sub BindGrid()
            Try
                ...
                Dim objDT As DataTable = Teams.SelectTeamsByBusinessAreaID(iBusinessAreaID)
