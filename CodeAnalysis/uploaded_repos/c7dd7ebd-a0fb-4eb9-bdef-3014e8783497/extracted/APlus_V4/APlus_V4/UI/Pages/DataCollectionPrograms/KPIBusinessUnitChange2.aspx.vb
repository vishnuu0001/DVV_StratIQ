...
Namespace WebApp.APlus.UI.Pages
    Partial Class KPIBusinessUnitChange2
        Inherits ApplicationBase

#Region " Private Variables"
        Private Shared ReadOnly FormName As String = "Business Unit Maintenance"
        Private Shared ReadOnly ProgramName As String = "KPIBusinessUnitChange2"
        ...
        Private Sub btnOK_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnOK.Click
            ...
            For iRow As Integer = 0 To mcKPI.Rows.Count - 1
                Try
                    ...
                    KPIMaster.UpdateKPIMasterBusinessUnit(iKPIID, iBusinessUnitID)

                    RecordTransactionHistory.InsertRecordTransactionHistory(DBTableName, iKPIID.ToString, "Business Unit Changed: " & strBusinessUnit, SessionManager.UserID)
            ...
            Response.Redirect(Context.Request.ApplicationPath & Path.AltDirectorySeparatorChar & ProgramSecurity.GetProgramURL("KPIBusinessUnitChange1"), False)
        End Sub
