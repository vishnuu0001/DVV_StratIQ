<%@ Page Language="VB" MasterPageFile="~/UI/Pages/MasterPages/ApplicationMaster.master"
    AutoEventWireup="false" CodeFile="MasterPlanSavings1.aspx.vb" Inherits="WebApp.APlus.UI.Pages.MasterPlanSavings1"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <br />
            <hr style="width: 99%; color: black; height: 1px">
            <asp:Table ID="tblBASavings" runat="server" Width="99%" GridLines="Both" CellPadding="1"
                CellSpacing="0" BorderColor="Black" BorderWidth="1" BorderStyle="Solid" BackColor="White"
                Style="margin: 2px;">
            </asp:Table>
            <br />
            ...
            <asp:Panel ID="pnlExit" runat="server">
                <table id="Table5" cellspacing="0" cellpadding="2" width="321" border="0">
                    <tr>
                        ...
                        <td align="left" style="width: 158px">
                            <asp:Button ID="btnMasterPlan" runat="server" CausesValidation="False" CssClass="Button_Variable"
                                Text="Master Plan Maintenance" />
                        </td>
                    </tr>
                </table>
            </asp:Panel>
