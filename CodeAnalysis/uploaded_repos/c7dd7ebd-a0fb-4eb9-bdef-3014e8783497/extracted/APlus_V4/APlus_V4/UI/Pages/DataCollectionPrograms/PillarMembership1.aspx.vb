...
Namespace WebApp.APlus.UI.Pages
    Partial Class PillarMembership1
        Inherits ApplicationBase

#Region " Private Constants"
        Private Shared ReadOnly FormName As String = "Pillar Membership Master"
        Private Shared ReadOnly ProgramName As String = "PillarMembershipMaster1"
#End Region
...
#Region " Event Handlers"
        ...
        Protected Sub MasterControl1_onRowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles MasterControl1.onRowCommand
            ...
            If e.CommandName = "ViewRow" OrElse e.CommandName = "EditRow" OrElse e.CommandName = "DeleteRow" Then
                SessionManager.SelectedValue = MasterControl1.MasterControlGrid.DataKeys(e.CommandArgument)("PillarAbbrev").ToString
                SessionManager.SelectedValue1 = MasterControl1.MasterControlGrid.DataKeys(e.CommandArgument)("UserID").ToString
                SessionManager.SelectedValue2 = MasterControl1.MasterControlGrid.DataKeys(e.CommandArgument)("SiteID").ToString
                SessionManager.PillarMembershipMode = e.CommandName
                LastPixelPositionUpdate(ProgramName, Master.CurrentPixelPosition)

                Response.Redirect(Context.Request.ApplicationPath & Path.AltDirectorySeparatorChar & ProgramSecurity.GetProgramURL("PillarMembershipMasterMaintenance2"), False)
            End If
        End Sub
#End Region
