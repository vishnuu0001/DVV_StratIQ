...
Namespace WebApp.APlus.UI.Pages
    Partial Class MasterPlanSavings1
...
#Region " Load Culture Translations"
        Private Sub LoadCultureTranslations()
            ...
            Try
                ...
                btnMasterPlan.Text = GetTranslationString("masterplanmaintenance", btnMasterPlan.Text)
            Catch Exc As Exception
...
#Region " Event Handlers"
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If SessionManager.CallingProgram = "MasterPlanSavings3" Then
                btnMasterPlan.Visible = False
            Else
                If ProgramSecurity.CanUserAccessProgram(SessionManager.UserID, "TrackerPlanMaster1") Then
                    btnMasterPlan.Visible = True
                Else
                    btnMasterPlan.Visible = False
                End If
            End If
        ...
        Private Sub ButtonClick(ByVal passArgs As String)
            ...
            Select Case strTarget(1)
                Case "Nav"
                    ...
                    BindSiteTotalsGrid()
                Case "Trackers"
                    SessionManager.SelectedValueTrackerPlanID = strTarget(2)
                    LastPixelPositionUpdate(ProgramName, Master.CurrentPixelPosition)
                    Response.Redirect(Context.Request.ApplicationPath & Path.AltDirectorySeparatorChar & ProgramSecurity.GetProgramURL("MasterPlanSavings2"), False)
        ...
        Protected Sub btnMasterPlan_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnMasterPlan.Click
            SessionManager.MasterControlExitProgram = "MasterPlanSavings1"
...
#Region " Custom Methods"
        Private Sub BindGrid()
            ...
            Dim objDT As DataTable = TrackerPlanSavings.SelectTrackerPlanSavingsCollection(iSiteID, SessionManager.TrackerSelNavYear, chkProjected.Checked)
            ...
            objRow = New TableRow
            objRow.Cells.Add(GenerateTableCell("", New Unit("14%"), New Unit(15), "#41519A", "#ffffff", HorizontalAlign.Left, VerticalAlign.Top, 1, BorderStyle.None, "", GenerateTableLink("<", "#E7E7FF", "Nav~" & (SessionManager.TrackerSelNavYear - 1).ToString, "Previous Year")))
            ...
            For Each dtRow As DataRow In objDT.Rows
                ...
                Select Case Convert.ToInt16(dtRow("RowType"))
                    Case 1
                        ...
                        lnkValue = GenerateTableLink("Savings", "#3333FF", "Trackers~" & dtRow("TrackerPlanID").ToString, "View Trackers")
                        objRow.Cells.Add(GenerateTableCell("Savings", New Unit("14%"), New Unit(5), strAlternatingRowColor, "#000000", HorizontalAlign.Left, VerticalAlign.NotSet, 1, BorderStyle.Solid, "", lnkValue))
                    Case 2
                ...
                For i As Integer = 9 To 21
                    ...
                    If Not dtRow(i) Is DBNull.Value AndAlso IsNumeric(dtRow(i)) Then
                        ...
                        If Convert.ToInt16(dtRow("RowType")) = 1 Then
                            If (objDT.Rows(intRowIndex + 1)(i) IsNot DBNull.Value AndAlso IsNumeric(objDT.Rows(intRowIndex + 1)(i))) AndAlso _
                            (objDT.Rows(intRowIndex + iStretchRow)(i) IsNot DBNull.Value AndAlso IsNumeric(objDT.Rows(intRowIndex + iStretchRow)(i))) Then
                                If Math.Round(CDbl(dtRow(i)), 0) >= Math.Round(CDbl(objDT.Rows(intRowIndex + iStretchRow)(i)), 0) Then
                                ...
                                End If
                            ElseIf (objDT.Rows(intRowIndex + iStretchRow)(i) IsNot DBNull.Value AndAlso IsNumeric(objDT.Rows(intRowIndex + iStretchRow)(i))) Then
                                If Math.Round(CDbl(dtRow(i)), 0) >= Math.Round(CDbl(objDT.Rows(intRowIndex + iStretchRow)(i)), 0) Then
                                    objCell.BackColor = Drawing.Color.LightGreen
                                Else
                                    objCell.BackColor = Drawing.Color.Salmon
            ...
            Next
        End Sub
        Private Sub BindBASavingsGrid()
            tblBASavings.Rows.Clear()
            ...
            Dim objDT As DataTable = TrackerPlanSavings.SelectTrackerPlanBASavingsCollection(iSiteID, SessionManager.TrackerSelNavYear, chkProjected.Checked)
            Dim objRow As TableRow
            Dim objCell As TableCell
            ...
            For Each dtRow As DataRow In objDT.Rows
                ...
                strCatDisplay = dtRow("SiteAbbrev").ToString.Trim
                If dtRow("BusinessAreaAbbrev").ToString.Trim.Length > 0 Then
                    strCatDisplay += " - " & dtRow("BusinessAreaAbbrev").ToString.Trim
                End If

                If strCategoryDisplayName <> strCatDisplay Then
                    tblBASavings.Rows.Add(GenerateTableRow(strIndent & strCatDisplay, "#FFFFFF", "#000000", HorizontalAlign.Left, BorderStyle.None, 15, True))
                    strCategoryDisplayName = strCatDisplay
                    iRowType = 1
                End If
                    ...
                    If Not dtRow(i) Is DBNull.Value AndAlso IsNumeric(dtRow(i)) Then
                        ...
                        If iRowType = 1 Then
                            ...
                            (objDT.Rows(intRowIndex + iStretchRow)(i) IsNot DBNull.Value AndAlso IsNumeric(objDT.Rows(intRowIndex + iStretchRow)(i))) Then
                                ...
                                End If
                            ElseIf (objDT.Rows(intRowIndex + iStretchRow)(i) IsNot DBNull.Value AndAlso IsNumeric(objDT.Rows(intRowIndex + iStretchRow)(i))) Then
                                If Math.Round(CDbl(dtRow(i)), 0) >= Math.Round(CDbl(objDT.Rows(intRowIndex + 2)(i)), 0) Then
                                    objCell.BackColor = Drawing.Color.LightGreen
                                Else
                                    objCell.BackColor = Drawing.Color.Salmon
                                End If
        ...
        Private Sub BindSiteTotalsGrid()
            ...
            Dim objDT As DataTable = TrackerPlanSavings.SelectTrackerPlanSavingsTotalsYTDBySite(iSiteID, SessionManager.TrackerSelNavYear, 0, chkProjected.Checked)
            Dim objRow As TableRow
            Dim objCell As TableCell
            Dim lnkValue As LinkButton = Nothing
            ...
            For Each dtRow As DataRow In objDT.Rows
                ...
                Select Case Convert.ToInt16(dtRow("RowType"))
                    Case 1
                        strAlternatingRowColor = "#FFFFFF"
                        lnkValue = GenerateTableLink("Savings", "#3333FF", "Trackers~0", "View Trackers")
                        objRow.Cells.Add(GenerateTableCell("Savings", New Unit("14%"), New Unit(5), strAlternatingRowColor, "#000000", HorizontalAlign.Left, VerticalAlign.NotSet, 1, BorderStyle.Solid, "", lnkValue))
                    Case 2
                        strAlternatingRowColor = "#CCCCCC"
                        objRow.Cells.Add(GenerateTableCell("Target", New Unit("14%"), New Unit(5), strAlternatingRowColor, "#000000", HorizontalAlign.Left, VerticalAlign.NotSet, 1, BorderStyle.Solid, ""))
