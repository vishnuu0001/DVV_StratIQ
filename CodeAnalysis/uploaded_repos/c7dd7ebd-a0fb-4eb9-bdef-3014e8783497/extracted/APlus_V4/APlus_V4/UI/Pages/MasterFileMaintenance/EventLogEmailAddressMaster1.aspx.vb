...
Namespace WebApp.APlus.UI.Pages
    Partial Class EventLogEmailAddressMaster1
        Inherits ApplicationBase

#Region " Private Constants"
        Private Shared ReadOnly FormName As String = "Eventlog Email Address Master"
        Private Shared ReadOnly ProgramName As String = "EventLogEmailAddressMaster1"
#End Region
...
#Region " Event Handlers"
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Master.IconImage = Request.ApplicationPath & "/images/mail2_view.gif"
        ...
        Protected Sub MasterControl1_onRowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles MasterControl1.onRowCommand
            ...
            Select Case e.CommandName
                Case "ViewRow", "EditRow", "DeleteRow"
                    SessionManager.SelectedValue = MasterControl1.MasterControlGrid.DataKeys(e.CommandArgument)("EmailAddress").ToString
                    SessionManager.SelectedValue1 = MasterControl1.MasterControlGrid.DataKeys(e.CommandArgument)("EmailInactive").ToString
                    SessionManager.EventLogEmailAddressMasterMode = e.CommandName
                    Response.Redirect(Context.Request.ApplicationPath & Path.AltDirectorySeparatorChar & ProgramSecurity.GetProgramURL("EventLogEmailAddressMaster2"), False)
            End Select
        End Sub
#End Region
