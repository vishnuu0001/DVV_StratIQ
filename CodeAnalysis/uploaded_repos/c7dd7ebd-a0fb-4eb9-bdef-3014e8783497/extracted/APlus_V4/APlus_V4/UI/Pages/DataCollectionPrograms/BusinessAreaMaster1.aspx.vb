...
Namespace WebApp.APlus.UI.Pages
    Partial Class BusinessAreaMaster1
        Inherits ApplicationBase

#Region " Private Constants"
        Private Shared ReadOnly FormName As String = "Business Area Maintenance"
        Private Shared ReadOnly ProgramName As String = "BusinessAreaMaster1"
#End Region
        ...
        Protected Sub MasterControl1_onRowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles MasterControl1.onRowCommand
            ...
            Select Case e.CommandName
                Case "ViewRow", "EditRow", "DeleteRow"
                    SessionManager.SelectedValueBusinessAreaID = MasterControl1.MasterControlGrid.DataKeys(e.CommandArgument)("BusinessAreaID").ToString
                    SessionManager.BusinessAreaMode = e.CommandName

                    Response.Redirect(Context.Request.ApplicationPath & Path.AltDirectorySeparatorChar & ProgramSecurity.GetProgramURL("BusinessAreaMaster2"), False)
            End Select
        End Sub
#End Region
