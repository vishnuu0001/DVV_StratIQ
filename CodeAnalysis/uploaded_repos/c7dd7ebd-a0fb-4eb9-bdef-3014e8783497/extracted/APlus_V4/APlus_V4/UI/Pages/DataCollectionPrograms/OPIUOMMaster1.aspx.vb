...
Namespace WebApp.APlus.UI.Pages
    Partial Class OPIUOMMaster1
        Inherits System.Web.UI.Page

#Region " Private Constants"
        Private Shared ReadOnly FormName As String = "OPI UOM Master"
        Private Shared ReadOnly ProgramName As String = "OPIUOMMaster1"
#End Region
...
#Region " Event Handlers"
        ...
        Protected Sub MasterControl1_onRowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles MasterControl1.onRowCommand
            ...
            If e.CommandName = "ViewRow" OrElse e.CommandName = "EditRow" OrElse e.CommandName = "DeleteRow" Then
                SessionManager.SelectedValue = MasterControl1.MasterControlGrid.DataKeys(e.CommandArgument)("OPIUOM").ToString
                SessionManager.SelectedValue1 = MasterControl1.MasterControlGrid.DataKeys(e.CommandArgument)("OPIUOMAbbrev").ToString
                SessionManager.SelectedValue2 = MasterControl1.MasterControlGrid.DataKeys(e.CommandArgument)("OPIUOMDescription").ToString
                SessionManager.Mode = e.CommandName
                LastPixelPositionUpdate(ProgramName, Master.CurrentPixelPosition)
                Response.Redirect(Context.Request.ApplicationPath & Path.AltDirectorySeparatorChar & ProgramSecurity.GetProgramURL("OPIUOMMaster2"), False)
            End If
        End Sub
#End Region
