<%@ Page Language="VB" ValidateRequest="false" MasterPageFile="~/UI/Pages/MasterPages/ApplicationMaster.master"
    AutoEventWireup="false" CodeFile="TeamOPIValues3.aspx.vb" Inherits="WebApp.APlus.UI.Pages.TeamOPIValues3"
    Title="OPI Data Import" EnableTheming="true" StylesheetTheme="APlus_Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel ID="pnlImport" runat="server" Visible="False">
        <asp:GridView ID="grdImport" runat="server" Width="100%" SkinID="GridView" AutoGenerateColumns="False">
            <Columns>
                <asp:BoundField DataField="OPIValueDateTime" HeaderText="DateTime" />
            </Columns>
        </asp:GridView>
