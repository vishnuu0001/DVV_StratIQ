...
Namespace WebApp.APlus.UI.Pages
    Partial Class InterfaceKPIDataElements1
        Inherits ApplicationBase

#Region " Private Constants"
        Private Shared ReadOnly FormName As String = "Interface KPI Data Elements"
        Private Shared ReadOnly ProgramName As String = "InterfaceKPIDataElements1"
#End Region
...
#Region " Event Handlers"
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Master.ProgramName = "InterfaceKPIDataElements1"
        ...
        Protected Sub MasterControl1_onRowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles MasterControl1.onRowCommand
            ...
            Select Case e.CommandName
                Case "EditRow"
                    ...
                    SessionManager.MasterControlExitProgram = "InterfaceKPIDataElements1"
                    Response.Redirect(Context.Request.ApplicationPath & Path.AltDirectorySeparatorChar & ProgramSecurity.GetProgramURL("KPIDataElements1"), False)
            End Select
        End Sub
#End Region
