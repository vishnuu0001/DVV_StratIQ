<%@ Page Language="VB" MasterPageFile="~/UI/Pages/MasterPages/ApplicationMaster.master"
    AutoEventWireup="false" CodeFile="EntityImport.aspx.vb" Inherits="WebApp.APlus.UI.SLICE.EntityImport"
    Title="Entity Import" ValidateRequest="false" EnableTheming="true" StylesheetTheme="APlus_Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function SetSpreadSheetTitle() {
            ...
            if (document.all.Spreadsheet1.TitleBar != null) {
                document.all.Spreadsheet1.TitleBar.Caption = "Import SLICE Data from Excel";

                document.all.Spreadsheet1.ActiveSheet.Cells(1, 1).Value = " SAP Entity ";
                document.all.Spreadsheet1.ActiveSheet.Cells(1, 2).Value = " Entity/Component ";
                document.all.Spreadsheet1.ActiveSheet.Cells(1, 3).Value = " Location ";
                ...
                document.all.Spreadsheet1.ActiveSheet.Cells(1, 1).Locked = true;
    ...
    <asp:Panel ID="Panel1" runat="server">
        ...
        <table id="tbButtons2" cellspacing="2" cellpadding="2" width="100%" border="0">
            <tr>
                <td style="width: 136px" align="left">
                    <input class="Button_Variable" onclick="ResizeText()" type="button" value="Reformat Data"
                        name="cmdResize" />
                </td>
                <td style="width: 136px" align="left">
    ...
    <asp:Panel ID="pnlImport" runat="server">
       <asp:GridView ID="gvImport" runat="server" AutoGenerateColumns="False" SkinID="GridView"
        ...
        <br />
        <br />
        <table id="tbButtons" style="height: 26px" cellspacing="2" cellpadding="2" border="0">
            <tr>
                <td style="width: 140px" align="left">
                    <p>
                        <asp:Button ID="btnImportData" runat="server" CssClass="Button_Default" Text="Load Data To Database"
                            Width="136px"></asp:Button></p>
                </td>
                <td style="width: 130px" align="left">
                    <asp:Button ID="btnCancel2" runat="server" CssClass="Button_Default" Text="Exit"
                        CausesValidation="False"></asp:Button>
                </td>
            </tr>
        </table>
