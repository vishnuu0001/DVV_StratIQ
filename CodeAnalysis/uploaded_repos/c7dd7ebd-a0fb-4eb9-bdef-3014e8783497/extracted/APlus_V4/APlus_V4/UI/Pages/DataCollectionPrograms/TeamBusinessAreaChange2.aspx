<%@ Page Language="VB" MasterPageFile="~/UI/Pages/MasterPages/ApplicationMaster.master"
    AutoEventWireup="false" CodeFile="TeamBusinessAreaChange2.aspx.vb" Inherits="WebApp.APlus.UI.Pages.TeamBusinessAreaChange2"
    Title="Team Area Maintenance" %>

<%@ MasterType TypeName="WebApp.APlus.UI.Pages.ApplicationMaster" %>
<%@ Register TagPrefix="CC1" Namespace="WebApp.APlus.UI.CustomControls" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <CC1:MasterControl ID="mcTeam" runat="server" ShowAdd="False" ShowDelete="False"
        ShowEdit="False" NewLinkCaption="Team" RedirectProgramName="TeamBusinessAreaChange2"
        FormName="Business Area" ProgramName="TeamBusinessAreaChange2" CommandText="spSelTeamsByTeamList"
