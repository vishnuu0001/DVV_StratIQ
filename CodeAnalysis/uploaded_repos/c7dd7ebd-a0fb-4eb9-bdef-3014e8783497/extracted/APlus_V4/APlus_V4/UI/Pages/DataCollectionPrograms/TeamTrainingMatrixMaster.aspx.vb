...
Namespace WebApp.APlus.UI.Pages
    Partial Class TeamTrainingMatrixMaster
        Inherits ApplicationBase

#Region " Constants"
        Private Shared ReadOnly FormName As String = "My Teams Training Matrices"
        Private Shared ReadOnly ProgramName As String = "MyTeamsTrainingMatrixMaster"
#End Region
...
#Region " Event Handlers"
        ...
        End Sub
        Protected Sub MasterControl1_AddClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles MasterControl1.AddClick
            SessionManager.JobMode = "AddMatrix"
        ...
        Protected Sub MasterControl1_onRowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles MasterControl1.onRowCommand
            ...
            Select Case e.CommandName
                Case "ViewRow", "EditRow"
                    ...
                    SessionManager.SelectedValueJobName = MasterControl1.Rows(CInt(e.CommandArgument)).Cells(1).Text
                    SessionManager.JobMode = e.CommandName & "Matrix"
                ...
                Case "Matrix"
                    SessionManager.MasterControlExitProgram = "MyTeamsTrainingMatrixMaster"
                    SessionManager.SelectedValueJob = MasterControl1.MasterControlGrid.DataKeys(e.CommandArgument)("JobID").ToString
                    SessionManager.SelectedValueJobName = MasterControl1.Rows(CInt(e.CommandArgument)).Cells(1).Text
