...
Namespace WebApp.APlus.UI.Pages
    Partial Class KPIReport2
        Inherits ApplicationBase

#Region " Private Variables"
        Private Shared ReadOnly FormName As String = "Operations KPIs"
        Private Shared ReadOnly ProgramName As String = "KPIReport2"
#End Region
...
#Region " Event Handlers"
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Master.HeaderMessage = "Operations KPIs"
            ...
            If Not Page.IsPostBack Then
                SessionManager.SelectedKPIReportGroupID = 2
                LoadDropDownLists()
        ...
        Protected Sub btnApplyFilter_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnApplyFilter.Click
            ...
            Dim cookie As New HttpCookie("KPIReport2Filter")
        ...
        Private Sub Button_Click(ByVal sender As System.Object, ByVal e As WebControls.CommandEventArgs)
            ...
            If strTarget.Length = 2 AndAlso IsNumeric(strTarget(1)) Then
                ...
                SessionManager.CallingProgram = "KPIReport2"
        ...
        Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
            ...
            Try
                ...
                Dim objDT As DataTable = KPIValues.SelectKPIReport2Collection(iYear, SessionManager.SelectedKPIReportGroupID, iBusinessAreaID, iSiteID)
                ...
                strHolder += "<td>D-2</td><td>D-1</td><td>MTD</td><td>YTD</td><td>Target</td></tr>"
        ...
        Protected Sub btnEditKPIReport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnEditKPIReport.Click
            SessionManager.MasterControlExitProgram = "KPIReport2"
            If ddlBusinessArea.SelectedItem IsNot Nothing AndAlso IsNumeric(ddlBusinessArea.SelectedItem.Value) Then
...
#Region " Custom Methods"
        ...
        Private Sub ApplyFiltersFromCookie()
            ...
            If Request.Cookies("KPIReport2Filter") IsNot Nothing Then
                Dim cookie As HttpCookie = Request.Cookies("KPIReport2Filter")
            ...
            For Each dtRow As DataRow In objDT.Rows
                ...
                For i As Integer = 13 To 29
                    ...
                    ElseIf dtRow("DailyKPICompare") AndAlso i > 24 AndAlso i < 28 Then
                        If IsNumeric(dtRow(i).ToString) Then
                            If IsNumeric(dtRow(i).ToString) AndAlso IsNumeric(dtRow("MTDT").ToString) Then
                                If bTargetUp Then
