...
Namespace WebApp.APlus.UI.Pages
    Partial Class PillarsMaster1
        Inherits ApplicationBase

#Region " Private Constants"
        Private Shared ReadOnly FormName As String = "Pillar Master"
        Private Shared ReadOnly ProgramName As String = "PillarMaster1"
#End Region
...
#Region " Event Handlers"
        ...
        Protected Sub MasterControl1_onRowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles MasterControl1.onRowCommand
            ...
            If e.CommandName = "ViewRow" OrElse e.CommandName = "EditRow" OrElse e.CommandName = "DeleteRow" Then
                ...
                SessionManager.SelectedValue1 = MasterControl1.MasterControlGrid.DataKeys(e.CommandArgument)("Pillar").ToString
                SessionManager.SelectedValue2 = MasterControl1.MasterControlGrid.DataKeys(e.CommandArgument)("PillarDefinition").ToString
                SessionManager.PillarMasterMode = e.CommandName
                Response.Redirect(Context.Request.ApplicationPath & Path.AltDirectorySeparatorChar & ProgramSecurity.GetProgramURL("PillarsMasterMaintenance2"), False)
            End If
        End Sub
#End Region
