...
Namespace WebApp.APlus.UI.Pages
    Partial Class TemplateAttachments1
...
#Region " Event Handlers"
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Master.IconImage = Request.ApplicationPath & "/images/user-has-new-email.gif"
            ...
            MasterControl1.StoredProcedureParams.Add("@AttachmentTypeID", AttachmentTypes.SelectAttachmentTypeIDByType("Template"))
        ...
        Protected Sub MasterControl1_onRowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles MasterControl1.onRowCommand
            ...
            Select Case e.CommandName
                Case "ViewFile"
                    Dim strDir As String = ConfigurationManager.AppSettings("TemplateAttachmentsVirtualRootDirectory")
                    strDir += New System.Globalization.CultureInfo(SessionManager.CulturePref).TwoLetterISOLanguageName + "/"
                    Dim strScript As String = "<script language='javascript'>LaunchExplorer('http://" & ConfigurationManager.AppSettings("ApplicationServerDNS").ToString
                    strScript += strDir & MasterControl1.Rows(CInt(e.CommandArgument)).Cells(2).Text & "')" & "</script>"
                ...
                Case "DeleteRow", "ViewRow"
                    ...
                    SessionManager.TemplateAttachmentMode = e.CommandName

                    Response.Redirect(Context.Request.ApplicationPath & Path.AltDirectorySeparatorChar & ProgramSecurity.GetProgramURL("TemplateAttachments2"), False)
            End Select
        End Sub
#End Region
