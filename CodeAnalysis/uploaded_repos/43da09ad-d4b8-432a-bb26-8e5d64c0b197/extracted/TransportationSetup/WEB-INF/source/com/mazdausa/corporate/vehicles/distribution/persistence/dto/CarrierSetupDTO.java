/**
 * This is the CarrierSetupDTO.java
...
public class CarrierSetupDTO {
	...
	private List<LabelValueBean> detailedCarrierTypeList;
	...
	public String getStreet3Address() {
		return street3Address;
	}

	public void setStreet3Address(String street3Address) {
		this.street3Address = street3Address;
	}
	...
	public List<LabelValueBean> getDetailedCarrierTypeList() {
		return detailedCarrierTypeList;
	}

	public void setDetailedCarrierTypeList(
			List<LabelValueBean> detailedCarrierTypeList) {
		this.detailedCarrierTypeList = detailedCarrierTypeList;
	}
