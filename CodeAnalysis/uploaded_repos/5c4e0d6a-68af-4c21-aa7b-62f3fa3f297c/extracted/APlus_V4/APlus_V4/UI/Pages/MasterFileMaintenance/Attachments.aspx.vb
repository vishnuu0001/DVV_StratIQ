...
#Region " Event Handlers"
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Master.HeaderMessage = SessionManager.AttachmentType & " Attachments"
            Master.AddBodyAttribute("onkeydown", "javascript:TrapEscKey(document.getElementById('" + btnExit.UniqueID + "'),window.event)")

            If SessionManager.AttachmentTypeID > 0 AndAlso SessionManager.AttachmentType.ToString.Trim.Length > 0 Then
                BindAttachments()
            End If
        End Sub
        Private Sub btnExit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExit.Click
            ...
            SessionManager.RemoveSessionVariable(SessionManager.SessionVariables.AttachmentType)
...
#Region " Custom Methods"
        Private Sub BindAttachments()
            ...
            Try
                Dim objDS As DataTable = BuildDataSet()
                ...
                If objDS.Rows.Count > 0 Then
                    For Each objDataRow As DataRow In objDS.Rows
                        'Check Category
                        If strCategory.Trim.ToUpper <> objDataRow("AttachmentCategory").ToString.Trim.ToUpper Then
                            'category has changed, add category row
                            objRow = New TableRow
                            objCell = New TableCell
                            objCell.ColumnSpan = 2
                            objCell.BackColor = System.Drawing.ColorTranslator.FromHtml("#4A3C8C")

                            objLabel = New Label
                            objLabel.Text = objDataRow("AttachmentCategory").ToString
                            objLabel.Font.Bold = True
                            objLabel.ForeColor = Drawing.Color.White
                ...
                End If
            Catch Exc As Exception
                Master.DisplayErrors(ProgramName & " - BindAttachments", Exc, SessionManager.UserID, CustomControls.ApplicationErrorControl.ApplicationErrorMessages.CustomError)
            End Try
        End Sub
        Public Function BuildDataSet() As DataTable
            Try
                If SessionManager.CheckEventTrackerLevel(SessionManager.EventTrackerLevels.UIMasterFile) Then
                    Dim functionInfo As System.Reflection.MethodBase = System.Reflection.MethodBase.GetCurrentMethod()
                    Dim strEventInfo As String = EventTracker.GetFunctionInformation(functionInfo)
            ...
            Try
                ...
                Try
                    strVirtualRoot = ConfigurationManager.AppSettings(SessionManager.AttachmentType.ToString + "AttachmentsVirtualRootDirectory")
                ...
                ds1 = DataAccess.Tables.AttachmentsMaster.SelectAttachmentsByTypeCultureLanguage(SessionManager.AttachmentTypeID, strCultureLanguage)
