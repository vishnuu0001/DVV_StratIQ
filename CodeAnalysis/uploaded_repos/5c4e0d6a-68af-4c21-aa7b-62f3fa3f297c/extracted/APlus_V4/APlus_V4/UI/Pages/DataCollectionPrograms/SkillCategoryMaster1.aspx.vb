...
Namespace WebApp.APlus.UI.Pages
    Partial Class SkillCategoryMaster1
        Inherits ApplicationBase

#Region " Private Constants"
        Private Shared ReadOnly FormName As String = "Skill Category Master"
        Private Shared ReadOnly ProgramName As String = "SkillCategoryMaster1"
#End Region
...
#Region " Event Handlers"
        ...
        Protected Sub MasterControl1_onRowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles MasterControl1.onRowCommand
            ...
            If e.CommandName = "ViewRow" Or e.CommandName = "DeleteRow" Or e.CommandName = "EditRow" Then
                SessionManager.SelectedValueCategoryID = MasterControl1.MasterControlGrid.DataKeys(e.CommandArgument)("SkillCategoryID").ToString
                SessionManager.SelectedValueCategory = MasterControl1.MasterControlGrid.DataKeys(e.CommandArgument)("SkillCategory").ToString
                SessionManager.SkillCategoryMode = e.CommandName
                Response.Redirect(Context.Request.ApplicationPath & Path.AltDirectorySeparatorChar & ProgramSecurity.GetProgramURL("SkillCategoryMaster2"), False)
            End If
        End Sub
#End Region
