<%@ Page Language="VB" MasterPageFile="~/UI/Pages/MasterPages/ApplicationMaster.master"
    AutoEventWireup="false" CodeFile="KPIValues1.aspx.vb" Inherits="WebApp.APlus.UI.Pages.KPIValues1"
    Title="KPI Values" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <CC1:MasterControl ID="MasterControl1" runat="server" ShowAdd="False" ShowDelete="False"
        ...
        <GridColumns>
            ...
            <CC1:MasterControlField DataField="Interface" HeaderText="Interface"
                Visible="false" />
            <CC1:MasterControlField DataField="OnDemandExecute" HeaderText="OnDemandExecute"
                Visible="false" />
        </GridColumns>
    </CC1:MasterControl>
    <br />
            ...
            <tr>
                ...
                <td align="left" style="width: 170px">
                    <asp:Button ID="btnKPIDaily" runat="server" CausesValidation="False" CssClass="Button_Variable"
                        Text="Show Daily KPIs" Visible="False" />
                </td>
                <td align="left" style="width: 158px">
                ...
                <td align="left" style="width: 158px">
                    <asp:Button ID="btnInterface" runat="server" CausesValidation="False" CssClass="Button_Variable"
                        Text="Rerun Interface" Visible="False" />
                </td>
                <td align="left" style="width: 200px">
                    <asp:CheckBox ID="ckDataEntryMode" runat="server" Text="Data Entry Mode" AutoPostBack="True"
                        Visible="False" />
                </td>
            </tr>
        </table>
