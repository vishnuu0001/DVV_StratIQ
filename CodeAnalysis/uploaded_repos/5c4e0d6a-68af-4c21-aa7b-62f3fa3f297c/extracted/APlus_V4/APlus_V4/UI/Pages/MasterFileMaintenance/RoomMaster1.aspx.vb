...
Namespace WebApp.APlus.UI.Pages
    Partial Class RoomMaster1
        Inherits ApplicationBase

#Region " Constants"
        Private Shared ReadOnly FormName As String = "Room Master"
        Private Shared ReadOnly ProgramName As String = "RoomMaster1"
#End Region
...
#Region " Event Handlers"
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If SessionManager.WorkingSite.ToString.Trim.Length = 0 Then
                Master.DisplayError("You must have a working site selected for Conference Room Maintenance")
            End If
        End Sub
        ...
        Protected Sub MasterControl1_onRowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles MasterControl1.onRowCommand
            ...
            If e.CommandName = "ViewRow" OrElse e.CommandName = "EditRow" OrElse e.CommandName = "DeleteRow" Then
                SessionManager.SelectedValueRoomID = MasterControl1.MasterControlGrid.DataKeys(e.CommandArgument)("RoomID")
                SessionManager.SelectedValueSiteID = MasterControl1.MasterControlGrid.DataKeys(e.CommandArgument)("SiteID")
                SessionManager.RoomMasterMode = e.CommandName
                Response.Redirect(Context.Request.ApplicationPath & Path.AltDirectorySeparatorChar & ProgramSecurity.GetProgramURL("RoomMaster2"), False)
            End If
        End Sub
#End Region
