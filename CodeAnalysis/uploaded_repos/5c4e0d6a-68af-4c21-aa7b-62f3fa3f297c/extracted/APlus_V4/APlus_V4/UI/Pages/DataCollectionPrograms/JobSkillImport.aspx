<%@ Page Language="VB" MasterPageFile="~/UI/Pages/MasterPages/ApplicationMaster.master"
    AutoEventWireup="false" ValidateRequest="false" CodeFile="JobSkillImport.aspx.vb"
    Inherits="WebApp.APlus.UI.Pages.JobSkillImport" Title="Job Skill Documents" EnableTheming="true"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script type="text/javascript" language="javascript">
        ...
        function SetpreadSheetTitle() {

            if (document.getElementById("Spreadsheet1") != null) {
                /* TITLE BAR CAPTION */
                document.all.Spreadsheet1.TitleBar.Caption = "Import Job Skill Data From Excel";

                /* COLUMN HEADERS */
                document.all.Spreadsheet1.ActiveSheet.Cells(1, 1).Value = " Job ";
                document.all.Spreadsheet1.ActiveSheet.Cells(1, 2).Value = " Skill Category ";
                document.all.Spreadsheet1.ActiveSheet.Cells(1, 3).Value = " Skill ";
                document.all.Spreadsheet1.ActiveSheet.Cells(1, 4).Value = " Assessment Criteria ";
                document.all.Spreadsheet1.ActiveSheet.Cells(1, 5).Value = " Sequence ";
                document.all.Spreadsheet1.ActiveSheet.Cells(1, 6).Value = " Required Rating ";
                document.all.Spreadsheet1.ActiveSheet.Cells(1, 7).Value = " Desired Rating ";
                ...
                document.all.Spreadsheet1.ActiveSheet.Cells(1,9).Value=" Target Time ";*/

                /* FONT STYLE */
                document.all.Spreadsheet1.ActiveSheet.Cells(1, 1).Font.Bold = true;
                document.all.Spreadsheet1.ActiveSheet.Cells(1, 2).Font.Bold = true;
                document.all.Spreadsheet1.ActiveSheet.Cells(1, 3).Font.Bold = true;
                document.all.Spreadsheet1.ActiveSheet.Cells(1, 4).Font.Bold = true;
                document.all.Spreadsheet1.ActiveSheet.Cells(1, 5).Font.Bold = true;
                document.all.Spreadsheet1.ActiveSheet.Cells(1, 6).Font.Bold = true;
                document.all.Spreadsheet1.ActiveSheet.Cells(1, 7).Font.Bold = true;
                /*document.all.Spreadsheet1.ActiveSheet.Cells(1,8).Font.Bold = true;
                document.all.Spreadsheet1.ActiveSheet.Cells(1,9).Font.Bold = true;*/
        ...
        function LoadExcelFromTextBox() {
            if (document.all.HTMLData.value != "") {
                if (document.getElementById("Spreadsheet1") != null) {
                    document.all.Spreadsheet1.HTMLData = document.all.HTMLData.value;
        ...
        function ImportFromExcel() {
            if (document.getElementById("Spreadsheet1") != null) {
                ...
                document.all.HTMLData.value = document.all.Spreadsheet1.HTMLData;
            }
        }
    </script>
    ...
    <asp:TextBox ID="HTMLData" runat="server" Height="0" Width="0"></asp:TextBox>
