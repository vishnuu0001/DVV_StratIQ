...
Namespace WebApp.APlus.UI.SLICE
    Partial Class WorkcenterMaster1
        Inherits ApplicationBase

#Region " Private Constants "
        Private Shared ReadOnly FormName As String = "Workcenter Master"
        Private Shared ReadOnly ProgramName As String = "WorkcenterMaster1"
#End Region
        ...
        Protected Sub MasterControl1_onRowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles MasterControl1.onRowCommand
            ...
            Select Case e.CommandName
                Case "ViewRow", "EditRow", "DeleteRow"
                    SessionManager.SelectedValueWorkcenterID = MasterControl1.MasterControlGrid.DataKeys(e.CommandArgument)("WorkcenterID").ToString
                    SessionManager.WorkcenterMasterMode = e.CommandName
                    Response.Redirect(Context.Request.ApplicationPath & Path.AltDirectorySeparatorChar & ProgramSecurity.GetProgramURL("WorkcenterMaster2"), False)
            End Select
        End Sub
#End Region
