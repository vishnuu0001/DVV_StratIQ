<%@ Page Language="VB" MasterPageFile="~/UI/Pages/MasterPages/ApplicationMaster.master"
    AutoEventWireup="false" CodeFile="TrainingDocumentAttachments2.aspx.vb" Inherits="WebApp.APlus.UI.Pages.TrainingDocumentAttachments2"
    ...
    <table class="Table_Default" id="Table1" cellspacing="2" cellpadding="2" border="0">
        <tr>
            <td style="width: 113px; height: 12px">
                <asp:Label ID="Label1" runat="server" Text="File:" CssClass="Label_Left_8PT"></asp:Label>
            </td>
