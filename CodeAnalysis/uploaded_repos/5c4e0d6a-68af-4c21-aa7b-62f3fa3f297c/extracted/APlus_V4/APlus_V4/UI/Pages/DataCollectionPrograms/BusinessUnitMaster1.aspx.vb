...
Namespace WebApp.APlus.UI.Pages
    Partial Class BusinessUnitMaster1
        Inherits ApplicationBase

#Region " Private Constants"
        Private Shared ReadOnly FormName As String = "Business Unit Maintenance"
        Private Shared ReadOnly ProgramName As String = "BusinessUnitMaster1"
#End Region
        ...
        Protected Sub MasterControl1_onRowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles MasterControl1.onRowCommand
            ...
            Select Case e.CommandName
                Case "ViewRow", "EditRow", "DeleteRow"
                    SessionManager.SelectedValueBusinessUnitID = MasterControl1.MasterControlGrid.DataKeys(e.CommandArgument)("BusinessUnitID").ToString
                    SessionManager.BusinessUnitMode = e.CommandName

                    Response.Redirect(Context.Request.ApplicationPath & Path.AltDirectorySeparatorChar & ProgramSecurity.GetProgramURL("BusinessUnitMaster2"), False)
            End Select
        End Sub
#End Region
