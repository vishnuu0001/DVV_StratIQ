...
Namespace WebApp.APlus.UI.Pages
    Partial Class MenuOptionMaster1
        Inherits ApplicationBase

#Region " Private Constants"
        Private Shared ReadOnly FormName As String = "Menu Option Master"
        Private Shared ReadOnly ProgramName As String = "MenuOptionMaster1"
#End Region
        ...
        Protected Sub MasterControl1_onRowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles MasterControl1.onRowCommand
            ...
            Select Case e.CommandName
                Case "ViewRow", "EditRow", "DeleteRow"
                    SessionManager.SelectedValueOptionMenu = MasterControl1.MasterControlGrid.DataKeys(e.CommandArgument)("Menu").ToString
                    SessionManager.SelectedValueOption = MasterControl1.MasterControlGrid.DataKeys(e.CommandArgument)("OptionValue").ToString

                    SessionManager.MenuOptionMode = e.CommandName
                    LastPixelPositionUpdate(ProgramName, Master.CurrentPixelPosition)

                    Response.Redirect(Context.Request.ApplicationPath & Path.AltDirectorySeparatorChar & ProgramSecurity.GetProgramURL("MenuOptionMaster2"), False)
            End Select
        End Sub
#End Region
