<%@ Page Language="VB" MasterPageFile="~/UI/Pages/MasterPages/ApplicationMaster.master"
    AutoEventWireup="false" CodeFile="MyTrackersPlan.aspx.vb" Inherits="WebApp.APlus.UI.Pages.MyTrackersPlan"
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <CC1:MasterControl ID="mcTrackerTypeTotals" runat="server" ShowAdd="False" ShowDelete="False"
                ...
                FormName="Tracker Maintenance" ProgramName="TrackerMaster1" CommandText="spSelMyTrackersPlanTotalsBySite"
                ...
                <GridColumns>
                    ...
                    <CC1:MasterControlField DataField="LastMonthSavings" HeaderText="Last Month Savings"
                        HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:0}">
                        <HeaderStyle HorizontalAlign="Right"></HeaderStyle>
                        <ItemStyle HorizontalAlign="Right"></ItemStyle>
                    </CC1:MasterControlField>
                    <CC1:MasterControlField DataField="LastMonthTarget" HeaderText="Last Month Target"
                        HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:0}">
                        <HeaderStyle HorizontalAlign="Right"></HeaderStyle>
                        <ItemStyle HorizontalAlign="Right"></ItemStyle>
                    </CC1:MasterControlField>
                    <CC1:MasterControlField DataField="CurrentYearSavings" HeaderText="YTD Savings" HeaderStyle-HorizontalAlign="Right"
                        ItemStyle-HorizontalAlign="Right" DataFormatString="{0:0}">
                        <HeaderStyle HorizontalAlign="Right"></HeaderStyle>
                        <ItemStyle HorizontalAlign="Right"></ItemStyle>
                    </CC1:MasterControlField>
                    <CC1:MasterControlField DataField="YTDTarget" HeaderText="YTD Target" HeaderStyle-HorizontalAlign="Right"
                        ItemStyle-HorizontalAlign="Right" DataFormatString="{0:0}">
                        <HeaderStyle HorizontalAlign="Right"></HeaderStyle>
                        <ItemStyle HorizontalAlign="Right"></ItemStyle>
                    </CC1:MasterControlField>
                    <CC1:MasterControlField DataField="CurrentTarget" HeaderText="Current Year Target"
                        HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:0}">
                        <HeaderStyle HorizontalAlign="Right"></HeaderStyle>
                        <ItemStyle HorizontalAlign="Right"></ItemStyle>
                    </CC1:MasterControlField>
                    <CC1:MasterControlField DataField="NextYearTarget" HeaderText="Next Year Target"
                        HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:0}">
                        <HeaderStyle HorizontalAlign="Right"></HeaderStyle>
                        <ItemStyle HorizontalAlign="Right"></ItemStyle>
                    </CC1:MasterControlField>
            ...
            <CC1:MasterControl ID="mcTrackerTotals" runat="server" ShowAdd="False" ShowDelete="False"
                ShowEdit="False" NewLinkCaption="Savings Tracker" RedirectProgramName="TrackerMaster2"
                FormName="Tracker Maintenance" ProgramName="TrackerMaster1" CommandText="spSelMyTrackersPlanTotalsByCurrency"
                ProgramMode="TrackerMode" AlternatingRows="True" PrimaryControl="False" ShowExit="False"
                ShowExport="False" ShowRowCount="False" ShowView="False" Translate="True">
                <GridColumns>
                    <CC1:MasterControlField DataField="SiteAbbrev" HeaderText="Site" />
            ...
            <br />
            <br />
            <CC1:MasterControl ID="mcMasterPlan" runat="server" ShowAdd="False" ShowDelete="False"
                ShowEdit="False" NewLinkCaption="Savings Tracker" RedirectProgramName="TrackerMaster2"
                FormName="Tracker Maintenance" ProgramName="TrackerMaster1" CommandText="spSelMasterPlanSavings"
                ProgramMode="TrackerMode" AlternatingRows="True" PrimaryControl="False" ShowExit="False"
                ShowExport="False" ShowRowCount="False" ShowView="False" Translate="True">
                <GridColumns>
                    <CC1:MasterControlField DataField="SiteAbbrev" HeaderText="Site" />
                    ...
                    <CC1:MasterControlField DataField="SavingsCategory" HeaderText="Category" />
                    <CC1:MasterControlField DataField="CurrencyAbbrev" HeaderText="Cur" />
                    <CC1:MasterControlField DataField="PlanSavings" HeaderText="Master Plan" HeaderStyle-HorizontalAlign="Right"
                        ItemStyle-HorizontalAlign="Right" DataFormatString="{0:0}">
                        <HeaderStyle HorizontalAlign="Right"></HeaderStyle>
                        <ItemStyle HorizontalAlign="Right"></ItemStyle>
                    </CC1:MasterControlField>
                    <CC1:MasterControlField DataField="CurrentYearSavings" HeaderText="Current Year Savings"
                        HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:0}">
                        <HeaderStyle HorizontalAlign="Right"></HeaderStyle>
                        <ItemStyle HorizontalAlign="Right"></ItemStyle>
                    </CC1:MasterControlField>
                    <CC1:MasterControlField DataField="PreviousYearSavings" HeaderText="Previous Year Savings"
                        HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:0}">
                        <HeaderStyle HorizontalAlign="Right"></HeaderStyle>
                        <ItemStyle HorizontalAlign="Right"></ItemStyle>
                    </CC1:MasterControlField>
