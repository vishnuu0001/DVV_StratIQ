...
Namespace WebApp.APlus.UI.Pages
    Partial Class AreaGroupAreaMaster1
        Inherits ApplicationBase

#Region " Private Constants"
        Private Shared ReadOnly FormName As String = "Area Group Maintenance"
        Private Shared ReadOnly ProgramName As String = "AreaGroupAreaMaster1"
#End Region
...
#Region " Event Handlers"
        ...
        Protected Sub MasterControl1_onRowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles MasterControl1.onRowCommand
            ...
            Select Case e.CommandName
                Case "DeleteRow"
                    SessionManager.SelectedValue1 = MasterControl1.MasterControlGrid.DataKeys(e.CommandArgument)("AreaID").ToString
                    SessionManager.AreaGroupAreaMasterMode = e.CommandName

                    Response.Redirect(Context.Request.ApplicationPath & Path.AltDirectorySeparatorChar & ProgramSecurity.GetProgramURL("AreaGroupAreaMaster2"), False)
            End Select
        End Sub
#End Region
