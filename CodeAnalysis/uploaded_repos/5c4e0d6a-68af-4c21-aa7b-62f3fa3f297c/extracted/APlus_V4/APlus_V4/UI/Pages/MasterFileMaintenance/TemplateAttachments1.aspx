<%@ Page Language="VB" MasterPageFile="~/UI/Pages/MasterPages/ApplicationMaster.master"
    AutoEventWireup="false" CodeFile="TemplateAttachments1.aspx.vb" Inherits="WebApp.APlus.UI.Pages.TemplateAttachments1"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <CC1:MasterControl ID="MasterControl1" runat="server" ShowExport="True" OnDataGrid_ItemCommand="dgItemCommand"
                CommandText="spSelAttachmentsMaster" ProgramName="TemplateAttachments1" FormName="Template Attachments"
                RedirectProgramName="TemplateAttachments2" NewLinkCaption="Template Attachment"
                ShowView="True" ShowEdit="False" ShowDelete="True" ShowAdd="True" ProgramMode="TemplateAttachmentMode"
