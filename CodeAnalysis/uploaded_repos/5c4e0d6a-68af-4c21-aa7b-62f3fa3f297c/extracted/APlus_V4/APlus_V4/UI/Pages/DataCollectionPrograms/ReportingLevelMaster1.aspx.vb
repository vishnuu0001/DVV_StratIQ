...
Namespace WebApp.APlus.UI.Pages
    Partial Class ReportingLevelMaster1
        Inherits ApplicationBase

#Region " Constants"
        Private Shared ReadOnly FormName As String = "Reporting Level Master"
        Private Shared ReadOnly ProgramName As String = "ReportingLevelMaster1"
#End Region
...
#Region " Event Handlers"
        ...
        Protected Sub MasterControl1_onRowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles MasterControl1.onRowCommand
            ...
            If e.CommandName = "ViewRow" OrElse e.CommandName = "EditRow" OrElse e.CommandName = "DeleteRow" Then
                SessionManager.SelectedValue = MasterControl1.MasterControlGrid.DataKeys(e.CommandArgument)("ReportingLevelID").ToString
                SessionManager.Mode = e.CommandName

                Response.Redirect(Context.Request.ApplicationPath & Path.AltDirectorySeparatorChar & ProgramSecurity.GetProgramURL("ReportingLevelMaster2"), False)
            End If
        End Sub
#End Region
