...
Namespace WebApp.APlus.UI.SLICE
    Partial Class SLICEResultMaster1
        Inherits ApplicationBase

#Region " Private Constants"
        Private Shared ReadOnly FormName As String = "SLICE Result Master"
        Private Shared ReadOnly ProgramName As String = "SLICEResultMaster1"
#End Region
...
#Region " Event Handlers"
        ...
        Protected Sub MasterControl1_onRowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles MasterControl1.onRowCommand
            ...
            If e.CommandName = "ViewRow" Or e.CommandName = "DeleteRow" Or e.CommandName = "EditRow" Then
                SessionManager.SelectedValueSLICEResultID = MasterControl1.MasterControlGrid.DataKeys(e.CommandArgument)("SLICEResultID").ToString
                SessionManager.SLICEResultMasterMode = e.CommandName
                Response.Redirect(Context.Request.ApplicationPath & Path.AltDirectorySeparatorChar & ProgramSecurity.GetProgramURL("SLICEResultMaster2"), False)
            End If
        End Sub
#End Region
