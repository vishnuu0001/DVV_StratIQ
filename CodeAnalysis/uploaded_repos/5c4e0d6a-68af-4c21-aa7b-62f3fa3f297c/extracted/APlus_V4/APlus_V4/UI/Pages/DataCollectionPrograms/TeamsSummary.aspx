<%@ Page Language="VB" MasterPageFile="~/UI/Pages/MasterPages/ApplicationMaster.master"
    AutoEventWireup="false" CodeFile="TeamsSummary.aspx.vb" Inherits="WebApp.APlus.UI.Pages.TeamsSummary"
    Title="Teams Summary" EnableTheming="true" StylesheetTheme="APlus_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <CC1:MasterControl ID="MasterControl1" runat="server" ProgramMode="TeamsMode" ShowAdd="False"
                ShowDelete="False" ShowEdit="False" ShowView="False" NewLinkCaption="Team" RedirectProgramName="TeamsMaintenance2"
                FormName="Teams Maintenance" ProgramName="TeamsMaintenance" CommandText="spSelTeamsSummary"
                ShowExport="True" AlternatingRows="True" ShowRowCount="False" Translate="True">
                <GridColumns>
                    <CC1:MasterControlField ShowReturns="False" DataField="TeamID" HeaderText="TeamID"
                        Visible="false" />
                    <CC1:MasterControlField ShowReturns="False" DataField="TeamNameOther" SortExpression="TeamNameOther"
                    ...
                    <CC1:MasterControlField ShowReturns="False" DataField="TeamLeader" SortExpression="TeamLeader"
                        HeaderText="Leader" />
                    ...
                    <CC1:MasterControlField ShowReturns="False" DataField="Duration" SortExpression="Duration"
                        HeaderText="Duration" />
                    <CC1:MasterControlField ShowReturns="False" DataField="EarliestPlanDate" SortExpression="EarliestPlanDate"
                        HeaderText="Earliest Plan Date" HtmlEncode="false" />
                    <CC1:MasterControlField ShowReturns="False" DataField="LatestPlanDate" SortExpression="LatestPlanDate"
                        HeaderText="Latest Plan Date" HtmlEncode="false" />
                    <CC1:MasterControlField ShowReturns="False" DataField="LastMeetingDate" SortExpression="LastMeetingDate"
                        HeaderText="Last Meeting Date" HtmlEncode="false" />
                </GridColumns>
            </CC1:MasterControl>
