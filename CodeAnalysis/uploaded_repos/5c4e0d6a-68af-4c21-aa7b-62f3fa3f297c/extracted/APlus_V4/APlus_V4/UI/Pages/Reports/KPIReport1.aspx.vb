...
Namespace WebApp.APlus.UI.Pages
    Partial Class KPIReport1
        Inherits ApplicationBase

#Region " Private Variables"
        Private Shared ReadOnly FormName As String = "Group KPIs"
        Private Shared ReadOnly ProgramName As String = "KPIReport1"
#End Region
...
#Region " Event Handlers"
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Master.HeaderMessage = "Group KPIs"
            ...
            If Not Page.IsPostBack Then
                SessionManager.SelectedKPIReportGroupID = 1
                LoadDropDownLists()
        ...
        Protected Sub btnApplyFilter_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnApplyFilter.Click
            Dim cookie As New HttpCookie("KPIReport1Filter")
            ...
            If ckAllReports.Checked Then
                cookie.Values("KPIReportCategory") = -1
            Else
                Dim strKPIReportCategory As String = String.Empty

                For i As Integer = 0 To lbReport.Items.Count - 1
                    If lbReport.Items(i).Selected Then
                        If strKPIReportCategory.Trim.Length > 0 Then strKPIReportCategory += ","

                        strKPIReportCategory += lbReport.Items(i).Value.ToString
                    End If
                Next

                If Not String.IsNullOrEmpty(strKPIReportCategory) Then
                    cookie.Values("KPIReportCategory") = strKPIReportCategory
                Else
                    cookie.Values.Remove("KPIReportCategory")
                End If
            End If

            If ckAllBusinessAreas.Checked Then
                cookie.Values("BusinessAreaID") = -1
            Else
        ...
        Private Sub Button_Click(ByVal sender As System.Object, ByVal e As WebControls.CommandEventArgs)
            ...
            If strTarget.Length = 2 AndAlso IsNumeric(strTarget(1)) Then
                ...
                SessionManager.CallingProgram = "KPIReport1"
        ...
        Protected Sub btnRunReport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRunReport.Click
            If ckAllReports.Checked AndAlso ckAllBusinessAreas.Checked Then
                Master.DisplayError("All KPIs and All Business Areas can not be checked at the same time")

                Return
            ElseIf ckAllReports.Checked Then
                If ddlBusinessArea.SelectedItem Is Nothing OrElse Not IsNumeric(ddlBusinessArea.SelectedItem.Value) Then
                    Master.DisplayError("Select Business Area")

                    Return
                End If

                RunAllReports()
            ElseIf ckAllBusinessAreas.Checked Then
                If lbReport.SelectedItem Is Nothing OrElse String.IsNullOrEmpty(lbReport.SelectedItem.Value.ToString) Then
                    Master.DisplayError("Select KPI")
        ...
        Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
            ...
            Try
                ...
                Dim strKPIReportCategory As String = ""
                Dim iBusinessAreaID As Integer = -1

                If ckAllReports.Checked Then
                    If lbReport.Items.Count > 0 Then
                        strKPIReportCategory = String.Empty
                    ...
                    End If
                Else
                    If lbReport.SelectedItem IsNot Nothing AndAlso Not String.IsNullOrEmpty(lbReport.SelectedItem.Value.ToString) Then
                        strKPIReportCategory = String.Empty
                    ...
                    End If
                End If
                If Not ckAllBusinessAreas.Checked Then
                    If ddlBusinessArea.SelectedItem IsNot Nothing AndAlso IsNumeric(ddlBusinessArea.SelectedItem.Value) Then
                ...
                Dim objDT As DataTable = KPIValues.SelectKPIReport1Collection(iYear, strKPIReportCategory, SessionManager.SelectedKPIReportGroupID, iBusinessAreaID)
                ...
                strHolder += "<td>KPI Group</td><td>KPI</td><td>Legend</><td>UOM</td><td>PIL</td><td>BU</td><td>Prev</td>"
                ...
                strHolder += "<td>Q1</td><td>Q2</td><td>Q3</td><td>Q4</td><td>YTD</td><td>Target</td></tr>"
                For Each dtRow As DataRow In objDT.Rows
                    strHolder += "<tr>"
                    strHolder += "<td>" + dtRow("KPIReportName").ToString.Trim & " : " & dtRow("BusinessArea").ToString.Trim + "</td>"
                    ...
                    strHolder += "<td>" & dtRow("PillarAbbrev").ToString.Trim & "</td>"
                    strHolder += "<td>" & dtRow("BusinessUnitAbbrev").ToString.Trim & "</td>"
                    ...
                    strHolder += "<td>" & dtRow("Q1").ToString.Trim & "</td>"
                    strHolder += "<td>" & dtRow("Q2").ToString.Trim & "</td>"
                    strHolder += "<td>" & dtRow("Q3").ToString.Trim & "</td>"
                    strHolder += "<td>" & dtRow("Q4").ToString.Trim & "</td>"
        ...
        Protected Sub btnEditKPIReport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnEditKPIReport.Click
            SessionManager.MasterControlExitProgram = "KPIReport1"
            If Not ckAllBusinessAreas.Checked AndAlso ddlBusinessArea.SelectedItem IsNot Nothing AndAlso IsNumeric(ddlBusinessArea.SelectedItem.Value) Then
            ...
            End If
            If Not ckAllReports.Checked AndAlso lbReport.GetSelectedIndices.Count = 1 AndAlso IsNumeric(lbReport.SelectedItem.Value) Then
                SessionManager.KPIReportFilterReportID = lbReport.SelectedItem.Value
            Else
...
#Region " Custom Methods"
        Private Sub LoadDropDownLists()
            Try
                ...
                lbReport.DataSource = objDT
                lbReport.DataTextField = "KPIReportName"
                lbReport.DataValueField = "KPIReportCategoryID"
                lbReport.DataBind()
        ...
        Private Sub ApplyFiltersFromCookie()
            ...
            If Request.Cookies("KPIReport1Filter") IsNot Nothing Then
                Dim cookie As HttpCookie = Request.Cookies("KPIReport1Filter")
                ...
                If cookie.Values("KPIReportCategory") IsNot Nothing Then
                    If IsNumeric(cookie.Values("KPIReportCategory")) AndAlso cookie.Values("KPIReportCategory") = -1 Then
                        ckAllReports.Checked = True
                    Else
                        Dim strReports As String() = cookie.Values("KPIReportCategory").Split(",")
                        For Each strReport As String In strReports
                            If IsNumeric(strReport) Then
                                If lbReport.Items.FindByValue(strReport) IsNot Nothing Then
                                    lbReport.Items.FindByValue(strReport).Selected = True
                                End If
                            End If
                        Next
                    End If
                ...
                If cookie.Values("BusinessAreaID") IsNot Nothing AndAlso IsNumeric(cookie.Values("BusinessAreaID")) Then
                    If Convert.ToInt16(cookie.Values("BusinessAreaID")) = -1 Then
                        ckAllBusinessAreas.Checked = True
                    Else
        ...
        Private Sub RunAllReports()
            Try
                ...
                For i As Integer = 0 To lbReport.Items.Count - 1
                    If IsNumeric(lbReport.Items(i).Value.ToString) Then
                        If strReportID.Trim.Length > 0 Then
                            strReportID += ","
                        End If
                        strReportID += lbReport.Items(i).Value.ToString
                    End If
                Next

                If Not String.IsNullOrEmpty(strReportID) Then
                    ...
                    strURL += "?ReportKey=KPIReportBase"
                    strURL += "&ReportParams="
                    strURL += "KPIReportCategoryID=" & strReportID
                    strURL += "|Year=" & txtYear.Text
            ...
            End Try
        End Sub
        Private Sub RunAllBusinessAreas()
            Try
                Dim strURL As String = ""
                Dim strScript As String = ""
                Dim strReportID As String = ""
                Dim strBusinessAreaID As String = ""

                For Each objItem As ListItem In ddlBusinessArea.Items
                    If IsNumeric(objItem.Value) Then
                        If strBusinessAreaID.Trim.Length > 0 Then
                            strBusinessAreaID += ","
                        End If
                        strBusinessAreaID += objItem.Value.ToString
                    End If
                Next
                ...
                If Not String.IsNullOrEmpty(strBusinessAreaID) AndAlso Not String.IsNullOrEmpty(strReportID) Then
                    strURL = Context.Request.ApplicationPath & Path.AltDirectorySeparatorChar & "UI/Pages/DataCollectionPrograms/WebReportPrintPreview.aspx"
                    strURL += "?ReportKey=KPIReportBase"
                    strURL += "&ReportParams="
                    strURL += "KPIReportCategoryID=" & strReportID
                    strURL += "|Year=" & txtYear.Text
                    strURL += "|BusinessAreaID=" & strBusinessAreaID
        ...
        Private Sub BindGrid()
            ...
            If Not ckAllReports.Checked Then
                If lbReport.SelectedItem IsNot Nothing AndAlso Not String.IsNullOrEmpty(lbReport.SelectedItem.Value.ToString) Then
                    strKPIReportCategory = String.Empty
            ...
            Dim strWidth1 As String = RegionalConversion.FormatLocalSingle("4.75")
            Dim strWidth2 As String = RegionalConversion.FormatLocalSingle("3.75")
            ...
            objRow.Cells.Add(GenerateTableCell("UOM", New Unit(strWidth1 & "%"), New Unit(15), "#FFFFFF", "#000000", HorizontalAlign.Center, VerticalAlign.Top, 1, BorderStyle.Solid, ""))
            objRow.Cells.Add(GenerateTableCell("PIL", New Unit("3%"), New Unit(15), "#FFFFFF", "#000000", HorizontalAlign.Center, VerticalAlign.Top, 1, BorderStyle.Solid, ""))
            objRow.Cells.Add(GenerateTableCell("BU", New Unit("3%"), New Unit(15), "#FFFFFF", "#000000", HorizontalAlign.Center, VerticalAlign.Top, 1, BorderStyle.Solid, ""))

            For i As Integer = 11 To 29
                objRow.Cells.Add(GenerateTableCell(objDT.Columns(i).ColumnName, New Unit(strWidth2 & "%"), New Unit(15), "#FFFFFF", "#000000", HorizontalAlign.Center, VerticalAlign.Top, 1, BorderStyle.Solid, ""))
            Next
            ...
            For Each dtRow As DataRow In objDT.Rows
                ...
                strCatDisplay = dtRow("KPIReportName").ToString.Trim & " : " & dtRow("BusinessArea").ToString.Trim
                ...
                objCell = New TableCell
                objCell.Width = New Unit(strWidth1 & "%")
                objCell.Height = New Unit(15)
                objCell.HorizontalAlign = HorizontalAlign.Center
                objCell.BackColor = System.Drawing.ColorTranslator.FromHtml(strAlternatingRowColor)
                objCell.BorderStyle = BorderStyle.Solid
                ...
                objCell.BackColor = System.Drawing.ColorTranslator.FromHtml(strAlternatingRowColor)
                objCell.BorderStyle = BorderStyle.Solid
                objCell.Text = dtRow("PillarAbbrev").ToString.Trim
                objRow.Cells.Add(objCell)
                ...
                objCell.BackColor = System.Drawing.ColorTranslator.FromHtml(strAlternatingRowColor)
                objCell.BorderStyle = BorderStyle.Solid
                objCell.Text = dtRow("BusinessUnitAbbrev").ToString.Trim
                objRow.Cells.Add(objCell)

                ' Previous year
                objCell = New TableCell
                objCell.Width = New Unit(strWidth2 & "%")
                objCell.Height = New Unit(15)
                objCell.HorizontalAlign = HorizontalAlign.Center
                objCell.BackColor = System.Drawing.ColorTranslator.FromHtml(strAlternatingRowColor)
                objCell.BorderStyle = BorderStyle.Solid
                ...
                For i As Integer = 12 To 29
                    ...
                    If i < 28 Then
                        If IsNumeric(dtRow(i).ToString) Then
                            If IsNumeric(dtRow(i).ToString) AndAlso IsNumeric(dtRow(i + 18).ToString) AndAlso IsNumeric(dtRow("Prev").ToString) Then
                                If bTargetUp Then
                                    If CDbl(dtRow(i).ToString) >= CDbl(dtRow(i + 18).ToString) Then
                                ...
                                Else
                                    ...
                                    End If
                                End If
                            ElseIf IsNumeric(dtRow(i).ToString) AndAlso IsNumeric(dtRow(i + 18).ToString) Then
                                If bTargetUp Then
                                    If CDbl(dtRow(i).ToString) >= CDbl(dtRow(i + 18).ToString) Then
                                        objCell.BackColor = Drawing.Color.LightGreen
                                    Else
