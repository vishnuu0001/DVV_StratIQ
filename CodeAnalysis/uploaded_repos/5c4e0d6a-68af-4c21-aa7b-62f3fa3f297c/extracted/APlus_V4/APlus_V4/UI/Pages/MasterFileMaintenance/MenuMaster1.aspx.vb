...
Namespace WebApp.APlus.UI.Pages
    Partial Class MenuMaster1
        Inherits ApplicationBase

#Region " Constants"
        Private Shared ReadOnly FormName As String = "Menu Master"
        Private Shared ReadOnly ProgramName As String = "MenuMaster1"
#End Region
        ...
        Protected Sub MasterControl1_onRowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles MasterControl1.onRowCommand
            ...
            Select Case e.CommandName
                Case "ViewRow", "EditRow", "DeleteRow"
                    SessionManager.SelectedValueMenu = MasterControl1.MasterControlGrid.DataKeys(e.CommandArgument)("Menu").ToString
                    SessionManager.MenuMode = e.CommandName
                    Response.Redirect(Context.Request.ApplicationPath & Path.AltDirectorySeparatorChar & ProgramSecurity.GetProgramURL("MenuMaster2"), False)
            End Select
        End Sub
#End Region
