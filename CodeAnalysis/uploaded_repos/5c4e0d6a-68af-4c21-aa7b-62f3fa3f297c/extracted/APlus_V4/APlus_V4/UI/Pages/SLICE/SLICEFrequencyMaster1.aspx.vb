...
Namespace WebApp.APlus.UI.SLICE
    Partial Class SLICEFrequencyMaster1
        Inherits ApplicationBase

#Region " Constants"
        Private Shared ReadOnly FormName As String = "SLICE Frequency Master"
        Private Shared ReadOnly ProgramName As String = "SLICEFrequencyMaster1"
#End Region
        ...
        Protected Sub MasterControl1_onRowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles MasterControl1.onRowCommand
            ...
            Select Case e.CommandName
                Case "ViewRow", "DeleteRow", "EditRow"
                    SessionManager.SelectedValueSLICEFrequencyID = MasterControl1.MasterControlGrid.DataKeys(e.CommandArgument)("SLICEFrequencyID").ToString
                    SessionManager.SelectedValueSLICEFrequency = MasterControl1.MasterControlGrid.DataKeys(e.CommandArgument)("SLICEFrequency").ToString
                    SessionManager.SLICEFrequencyMasterMode = e.CommandName
                    Response.Redirect(Context.Request.ApplicationPath & Path.AltDirectorySeparatorChar & ProgramSecurity.GetProgramURL("SLICEFrequencyMaster2"), False)
            End Select
        End Sub
#End Region
