...
Namespace WebApp.APlus.UI.Pages
    Partial Class UserJobMaster1
        Inherits ApplicationBase

#Region " Constants"
        Private Shared ReadOnly FormName As String = "User Job Master"
        Private Shared ReadOnly ProgramName As String = "UserJobMaster1"
#End Region
...
#Region " Event Handlers"
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            MasterControl1.GridColumns(6).DataFormatString = "{0:yyyy/MM/dd}"

            If SessionManager.SelectedTeamID = 0 Then
                MasterControl1.FunctionButtonOne.Visible = False
            Else
                If UserJobMaster.SelectTeamMembersCountNotInJob(SessionManager.SelectedValueJob, SessionManager.SelectedTeamID) = 0 Then
                    MasterControl1.FunctionButtonOne.Visible = False
                End If
            End If
        End Sub
        ...
        Protected Sub MasterControl1_FunctionButtonOneClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles MasterControl1.FunctionButtonOneClick
            ...
            Try
                UserJobMaster.AddAllTeamMembersToJob(SessionManager.SelectedValueJob, SessionManager.SelectedTeamID)
                If UserJobMaster.SelectTeamMembersCountNotInJob(SessionManager.SelectedValueJob, SessionManager.SelectedTeamID) = 0 Then
                    MasterControl1.FunctionButtonOne.Visible = False
                End If
                ...
                MasterControl1.DataBind()
            Catch Exc As Exception
                Master.DisplayErrors(ProgramName & " - MasterControl1_FunctionButtonOneClick", Exc, SessionManager.UserID, CustomControls.ApplicationErrorControl.ApplicationErrorMessages.CustomError)
            End Try
        End Sub
        Protected Sub MasterControl1_onRowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles MasterControl1.onRowCommand
            ...
            Select Case e.CommandName
                Case "DeleteRow"
                    SessionManager.SelectedValueUserJobUser = MasterControl1.MasterControlGrid.DataKeys(e.CommandArgument)("UserID").ToString
                    SessionManager.UserJobMode = e.CommandName
                    Response.Redirect(Context.Request.ApplicationPath & Path.AltDirectorySeparatorChar & ProgramSecurity.GetProgramURL("UserJobMaster3"), False)
            End Select
        End Sub
#End Region
