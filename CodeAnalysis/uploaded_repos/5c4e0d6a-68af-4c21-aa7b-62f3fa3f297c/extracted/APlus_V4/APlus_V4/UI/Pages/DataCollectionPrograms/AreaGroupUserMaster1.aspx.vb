...
Namespace WebApp.APlus.UI.Pages
    Partial Class AreaGroupUserMaster1
        Inherits ApplicationBase

#Region " Constants"
        Private Shared ReadOnly FormName As String = "Area User Maintenance"
        Private Shared ReadOnly ProgramName As String = "AreaGroupUserMaster1"
#End Region
...
#Region " Event Handlers"
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If SessionManager.SelectedValueAreaGroupID > 0 Then
                MasterControl1.StoredProcedureParams.Add("@AreaGroupID", SessionManager.SelectedValueAreaGroupID)
            End If

            If SessionManager.AreaGroupMasterMode.Trim.Length > 0 AndAlso SessionManager.AreaGroupMasterMode <> "EditRow" Then
        ...
        Protected Sub MasterControl1_onRowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles MasterControl1.onRowCommand
            ...
            Select Case e.CommandName
                Case "ViewRow", "EditRow", "DeleteRow"
                    SessionManager.SelectedValueAreaGroupID = MasterControl1.MasterControlGrid.DataKeys(e.CommandArgument)("AreaGroupID")
                    SessionManager.SelectedValue1 = MasterControl1.MasterControlGrid.DataKeys(e.CommandArgument)("UserID")
                    SessionManager.Mode = e.CommandName
                    Response.Redirect(Context.Request.ApplicationPath & Path.AltDirectorySeparatorChar & ProgramSecurity.GetProgramURL("AreaGroupUserMaster2"), False)
            End Select
        End Sub
#End Region
