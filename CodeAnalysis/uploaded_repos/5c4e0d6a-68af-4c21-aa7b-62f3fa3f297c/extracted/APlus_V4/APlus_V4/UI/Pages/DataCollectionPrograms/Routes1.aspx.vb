...
#Region " Constants"
        ...
        Private Shared ReadOnly ProgramName As String = "Routes1"
#End Region
...
#Region " Event Handlers"
        ...
        Protected Sub MasterControl1_onRowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles MasterControl1.onRowCommand
            ...
            Select Case e.CommandName
                Case "ViewRow"
                    SessionManager.SelectedRoute = MasterControl1.MasterControlGrid.DataKeys(e.CommandArgument)("RouteAbbrev").ToString
                    SessionManager.RoutesMode = e.CommandName
                    Response.Redirect(Context.Request.ApplicationPath & Path.AltDirectorySeparatorChar & ProgramSecurity.GetProgramURL("RoutesMasterMaintenance3"), False)
                Case "EditRow"
                    SessionManager.SelectedRoute = MasterControl1.MasterControlGrid.DataKeys(e.CommandArgument)("RouteAbbrev").ToString
                    SessionManager.RoutesMode = e.CommandName
