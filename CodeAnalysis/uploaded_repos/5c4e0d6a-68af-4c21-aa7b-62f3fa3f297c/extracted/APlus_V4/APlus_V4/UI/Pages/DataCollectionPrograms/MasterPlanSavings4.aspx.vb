...
Namespace WebApp.APlus.UI.Pages
    Partial Class MasterPlanSavings4
...
#Region " Event Handlers"
        ...
        Protected Sub btnApplyFilter_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnApplyFilter.Click
            If (ddlSite.SelectedItem Is Nothing OrElse String.IsNullOrEmpty(ddlSite.SelectedItem.Value.ToString)) _
            AndAlso (ddlBusArea.SelectedItem Is Nothing OrElse String.IsNullOrEmpty(ddlBusArea.SelectedItem.Value.ToString)) Then
        ...
        End Sub
        Protected Sub btnLocalCurrency_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnLocalCurrency.Click
            Dim cookie As New HttpCookie("MasterPlanProgram", "MasterPlanSavings3")
...
#Region " Custom Methods"
        ...
        Private Sub BindGrids()
            Try
                ...
                Dim objDT As DataTable = TrackerPlanSavings.SelectTrackerPlanSavingsOverviewEUR(SessionManager.TrackerSelNavYear, iSiteID, iBusinessAreaID, chkProjected.Checked)
                If objDT IsNot Nothing Then
                    BindGrid(objDT)
                End If
                objDT = TrackerPlanSavings.SelectTrackerPlanSavingsOverviewEUR2(SessionManager.TrackerSelNavYear, iSiteID, iBusinessAreaID, chkProjected.Checked)
                If objDT IsNot Nothing Then
                    BindSiteTotalsGrid(objDT)
                End If
                objDT = TrackerPlanSavings.SelectTrackerPlanSavingsOverviewEUR3(SessionManager.TrackerSelNavYear, iSiteID, iBusinessAreaID, chkProjected.Checked)
                If objDT IsNot Nothing Then
        ...
        Private Sub BindGrid(ByVal passData As DataTable)
            ...
            For Each dtRow As DataRow In passData.Rows
                ...
                strCatDisplay = dtRow("Site").ToString.Trim
        ...
        Private Sub BindSiteTotalsGrid(ByVal passData As DataTable)
            ...
            tblBATotals.Rows.Add(GenerateTableRow(strIndent & "Totals", "#FFFFFF", "#000000", HorizontalAlign.Left, BorderStyle.None, 16, True))
