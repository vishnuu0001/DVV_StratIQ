...
Namespace WebApp.APlus.UI.Pages
    Partial Class KPIBusinessAreaChange1
        Inherits ApplicationBase

#Region " Members"
        Private Shared ReadOnly FormName As String = "KPI Business Area Change"
        Private Shared ReadOnly ProgramName As String = "KPIBusinessAreaChange1"
...
#Region " Event Handlers"
        ...
        Protected Sub btnProcess_Click(sender As Object, e As System.EventArgs) Handles btnProcess.Click
            ...
            If strKPI.Trim.Length > 0 Then
                ...
                Response.Redirect(Context.Request.ApplicationPath & Path.AltDirectorySeparatorChar & ProgramSecurity.GetProgramURL("KPIBusinessAreaChange2"), False)
            End If
        End Sub
#End Region
...
#Region " Methods"
        ...
        Private Sub BindGrid()
            Try
                ...
                Dim objDT As DataTable = KPIMaster.SelectKPIMasterByBusinessAreaID(iBusinessAreaID)
