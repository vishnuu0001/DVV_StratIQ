...
#Region " Private Variables"
        Private cnSubConnection As New SqlConnection(ConfigurationManager.AppSettings("AttendanceConnectionString").ToString.Trim())
#End Region
...
#Region " Open Connection"
        ...
        Public Shared Function OpenMasterConnection() As SqlConnection
            Dim cnMasterConnection As New SqlConnection(ConfigurationManager.AppSettings("AttendanceConnectionString").ToString)
