...
Namespace WebApp.APlus.DataAccess.Tables
    Public Class SavingsCategoryMaster

#Region " Select"
        Public Shared Sub GetSavingsCategoryList(ByRef ddlList As System.Web.UI.WebControls.DropDownList, Optional ByRef cnMasterConnection As SqlConnection = Nothing)
            Try
            ...
            Dim cmSelect As New SqlCommand("spSelSavingsCategoryMasterList", cnSubConnection.OpenConnection(cnMasterConnection))
