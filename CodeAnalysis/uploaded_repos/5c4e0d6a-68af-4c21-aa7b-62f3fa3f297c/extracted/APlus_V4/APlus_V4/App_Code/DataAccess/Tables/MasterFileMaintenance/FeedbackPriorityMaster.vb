...
Namespace WebApp.APlus.DataAccess.Tables
    Public Class FeedbackPriorityMaster

#Region " Return Dropdownlist values"
        Public Shared Sub SelectFeedbackPriorityMasterList(ByRef ddlList As System.Web.UI.WebControls.DropDownList, Optional ByRef cnMasterConnection As SqlConnection = Nothing)
            Try
            ...
            Dim cmSelect As New SqlCommand("spSelFeedbackPriorityMasterList", cnSubConnection.OpenConnection(cnMasterConnection))
