...
function AllowOnlyNumbers(event){
	if((event.keyCode>=48 && event.keyCode<=57)||(event.keyCode==8)||(event.keyCode==46)||(event.keyCode>=96 && event.keyCode<=105)||(event.keyCode==190)||(event.keyCode==110)||(event.keyCode>=37 && event.keyCode<=40))
	{event.returnValue=true;return true;}
	else{event.returnValue=false;return false;}}
...
function AllowNegativeNumbers(event){
	if((event.keyCode>=48 && event.keyCode<=57)||(event.keyCode==8)||(event.keyCode==46)||(event.keyCode>=96 && event.keyCode<=105)||(event.keyCode==190)||(event.keyCode==110)||(event.keyCode>=37 && event.keyCode<=40)||(event.keyCode==109)||(event.keyCode==189))
	{event.returnValue=true;return true;}
	else{event.returnValue=false;return false;}}
function AllowOnlyNegIntegers(event) {
    if ((event.keyCode >= 48 && event.keyCode <= 57) || (event.keyCode == 8) || (event.keyCode == 46) || (event.keyCode >= 96 && event.keyCode <= 105) || (event.keyCode == 110) || (event.keyCode >= 37 && event.keyCode <= 40))
    { event.returnValue = true; return true; }
    else { event.returnValue = false; return false; }}
