...
# Function: _gcp_collect_disks
def _gcp_collect_disks(instance) -> tuple:
    disks: list[DiskInfo] = []
    total_gb = 0.0
    for ad in (instance.disks or []):
        ...
        total_gb += sz
    return disks, total_gb


# Function: _gcp_collect_interfaces
def _gcp_collect_interfaces(instance) -> tuple:
    ...
    return ifaces, primary_ip


# Function: _instance_to_server
def _instance_to_server(instance, project: str, zone: str) -> DiscoveredServer:
    ...
    disks, total_gb = _gcp_collect_disks(instance)
    ifaces, primary_ip = _gcp_collect_interfaces(instance)
...
# Function: _sql_database_version_to_workload
