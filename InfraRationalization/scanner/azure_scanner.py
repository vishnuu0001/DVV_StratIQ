# ---------------------------------------------------------------------------
# Author: Vishnuu A
# Scope: scanner/azure_scanner.py
# Date: 2026-01-17
# ---------------------------------------------------------------------------
"""
...
# Function: _vm_collect_disks
def _vm_collect_disks(vm) -> tuple:
    disks: list[DiskInfo] = []
    total_gb = 0.0
...
# Function: _vm_collect_interfaces
def _vm_collect_interfaces(vm, network_client, sub_id: str, rg: str) -> tuple:
...
def _vm_to_server(vm, compute_client, network_client, sub_id: str) -> DiscoveredServer:
    ...
    disks, total_gb = _vm_collect_disks(vm)
    ifaces, primary_ip = _vm_collect_interfaces(vm, network_client, sub_id, rg)
...
# Function: _scan_azure_databases
