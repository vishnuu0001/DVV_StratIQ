...
const ScanProgressPage        = lazy(() => import('./pages/ScanProgressPage.jsx'))
const ScanDetailPage          = lazy(() => import('./pages/ScanDetailPage.jsx'))
const NetworkIntelligencePage = lazy(() => import('./pages/NetworkIntelligencePage.jsx'))
const PdfAnalysisPage         = lazy(() => import('./pages/PdfAnalysisPage.jsx'))
const ExecutionSupportPage    = lazy(() => import('./pages/ExecutionSupportPage.jsx'))
import {
  clearPortalToken,
