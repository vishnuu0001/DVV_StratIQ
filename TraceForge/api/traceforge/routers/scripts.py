...
async def download_project_scripts(
    ...
    package_json = {
        ...
        "scripts": {
            ...
            "test:unconfigured": "playwright test --grep-invert READY_FOR_UI_AUTOMATION",
...
6. Run the already-generated scripts after the target environment configuration is verified.
"""
...
This suite contains generated scripts for all {total} approved test cases. **{blocked_count} scripts do not yet have verified runtime UI bindings** because the following are not yet available:
