// ---------------------------------------------------------------------------
// Author: Vishnuu A
// Scope: AppRationalization — frontend/src/components/business-capability (StandardizationERP.jsx)
// Date: 2026-04-19
// ---------------------------------------------------------------------------
              ...
              <div className="mt-12 bg-gradient-to-br from-indigo-50 to-purple-50 rounded-xl shadow-md p-8 border border-indigo-200">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-indigo-600">Generated by LLM model: <strong>{modelDisplayName(llm.model_used)}</strong></p>
                  </div>
                </div>
