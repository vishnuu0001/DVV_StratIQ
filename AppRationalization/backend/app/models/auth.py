# ---------------------------------------------------------------------------
# Author: Vishnuu A
# Scope: AppRationalization — backend/app/models (auth.py)
# Date: 2025-08-16
# ---------------------------------------------------------------------------
...
NOVASTRA_ITSM = "NOVASTRA_ITSM"
LAB_ROBOT = "LAB_ROBOT"
HOSPITAL_MANAGEMENT_SYSTEM = "HOSPITAL_MANAGEMENT_SYSTEM"
IMAGE_VISION = "IMAGE_VISION"
ROBOT_AUTOMATION = "ROBOT_AUTOMATION"
DASHBOARD = "DASHBOARD"
INTUNE_AUTOMATION = "INTUNE_AUTOMATION"
TOOL_ANALYSIS_QUALIFICATION = "TOOL_ANALYSIS_QUALIFICATION"
SSDLC_PROCESS_ASSESSMENT = "SSDLC_PROCESS_ASSESSMENT"
MICROSITE_DATA_ANALYSIS = "MICROSITE_DATA_ANALYSIS"
AI_REMAN_CORE = "AI_REMAN_CORE"
AI_VEHICLE_LOAN = "AI_VEHICLE_LOAN"
OPPORTUNITY_TRACKER = "OPPORTUNITY_TRACKER"
SUPPLY_CHAIN_DISRUPTION_MANAGER = "SUPPLY_CHAIN_DISRUPTION_MANAGER"
