# ---------------------------------------------------------------------------
# Author: Vishnuu A
# Scope: Configuration for Flask application with dynamic database support
# Date: 2025-12-05
# ---------------------------------------------------------------------------
...
# Function: _postgresql_database_uri
def _postgresql_database_uri():
    """Build (and normalize the driver of) the PostgreSQL connection string from DATABASE_URL."""
...
# Function: _sqlite_database_uri
def _sqlite_database_uri():
    """Build the SQLite connection string: custom path → in-memory (tests) → instance folder default."""
...
def get_database_uri():
    ...
    if db_provider == 'postgresql':
        return _postgresql_database_uri()

    return _sqlite_database_uri()


# Function: get_sqlalchemy_options
