# ---------------------------------------------------------------------------
# Author: Vishnuu A
# Scope: AppRationalization — backend/app/services (capability_service.py)
# Date: 2025-09-16
# ---------------------------------------------------------------------------
import json
import uuid
...
class CapabilityService:
    ...
    # Function: map_application_to_capability
    @staticmethod
    ...
    # Function: get_capability_with_applications
    @staticmethod
    ...
    # Function: initialize_default_capabilities
    @staticmethod
