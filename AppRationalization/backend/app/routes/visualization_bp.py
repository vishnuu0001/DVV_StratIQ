# ---------------------------------------------------------------------------
# Author: Vishnuu A
# Scope: AppRationalization — backend/app/routes (visualization_bp.py)
# Date: 2026-05-03
# ---------------------------------------------------------------------------
...
# Function: get_capability_by_name
...
# Function: create_capability_mapping
...
# Function: get_rationalization_scenarios
...
# Function: get_rationalization_scenario
...
# Function: get_scenarios_by_capability
...
# Function: create_rationalization_scenario
...
# Function: get_initialization_status
...
# Function: clear_standardization_data
...
# Function: get_standardization_analysis
