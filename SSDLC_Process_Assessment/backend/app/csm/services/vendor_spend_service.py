# ---------------------------------------------------------------------------
# Author: Vishnuu A
# Scope: SSDLC_Process_Assessment — backend/app/csm/services (vendor_spend_service.py)
# Date: 2025-08-18
# ---------------------------------------------------------------------------
...
from app.csm.models.vendor_spend import VendorSpendRecord, SpendBreakdown, VendorSpendSummary
