// ---------------------------------------------------------------------------
// Author: Vishnuu A
// Scope: SSDLC_Process_Assessment — csm_frontend/src/components/charts (TopVendorsChart.tsx)
// Date: 2026-02-08
// ---------------------------------------------------------------------------
import {
  BarChart,
...
export default function TopVendorsChart({ data }: Props) {
  ...
  const top10 = [...data].sort((a, b) => b.annual_spend - a.annual_spend).slice(0, 10)
