// ---------------------------------------------------------------------------
// Author: Vishnuu A
// Scope: SSDLC_Process_Assessment — frontend/src/pages (UploadPage.tsx)
// Date: 2026-02-07
// ---------------------------------------------------------------------------
...
export default function UploadPage() {
  ...
  const { workbookId, setWorkbookId, clearWorkbook } = useWorkbook()
  ...
  useEffect(() => {
    if (!workbookId) resetUploadState()
  }, [workbookId, resetUploadState])
                  ...
                  <div className="grid grid-cols-2 gap-2 sm:grid-cols-3">
                    {result.sheets.map((sheet) => (
                      ...
                      >
                        ...
                        <span className="text-slate-300 truncate">{sheet.name}</span>
                      </div>
                    ))}
                  </div>
                </div>
                  ...
                  <div className="flex items-start gap-3 p-3 bg-accent-amber/10 border border-accent-amber/20 rounded-lg">
                    ...
                    <div>
                      ...
                      <ul className="space-y-0.5">
                        {result.validation.map((w: string, i: number) => (
